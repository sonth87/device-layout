    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-black/50 dark:text-white/50 mb-5">
          Control how and when apps can send you notifications.
        </p>
      </div>

      <div className="rounded-[var(--radius-card)] bg-white dark:bg-neutral-700/50 px-4 py-8 flex flex-col items-center justify-center text-center gap-2">
