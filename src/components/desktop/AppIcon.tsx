...
function MobileContextMenu({
  ...
  return createPortal(
    <>
      ...
      {/* menu */}
      <div
        className="fixed z-9999 min-w-48 bg-white/90 dark:bg-neutral-800/90 backdrop-blur-2xl rounded-[var(--radius-card)] shadow-2xl border border-black/10 dark:border-white/10 p-1 text-xs overflow-hidden"
    ...
    <>
      ...
      <ContextMenu.Root>
        ...
        {appConfig.contextMenu && appConfig.contextMenu.length > 0 && (
          <ContextMenu.Portal>
            <ContextMenu.Content className="min-w-48 bg-white/85 dark:bg-neutral-800/85 backdrop-blur-2xl rounded-[var(--radius-card)] shadow-2xl border border-black/10 dark:border-white/10 p-1 text-xs overflow-hidden z-9999">
              <ContextMenuItems
                items={appConfig.contextMenu}
                appId={appConfig.id}
