...
export function WeatherWidget({ size }: Props) {
  if (size === 'small') {
    return (
      <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-500/15 to-cyan-400/10">
  ...
  return (
    <div className="w-full h-full flex flex-col bg-gradient-to-br from-blue-500/15 to-cyan-400/10 p-4">
