import {
  ...
  u as b,
  v as x,
} from "./Combination-dkRdWOFm.js";
import { r as S, t as C } from "./store-Cj2celzj.js";
...
import { t as oe } from "./useTranslation-cANnzTeW.js";
...
import {
  ...
  createElement as pe,
  forwardRef as me,
  isValidElement as he,
  lazy as D,
  useCallback as O,
  useContext as k,
  useEffect as A,
  useId as ge,
  useInsertionEffect as _e,
  useLayoutEffect as ve,
  useMemo as ye,
  useRef as j,
  useState as M,
} from "react";
...
var L = /* @__NO_SIDE_EFFECTS__ */ (e) => e,
  Fe = (e, t) => (n) => t(e(n)),
  Ie = (...e) => e.reduce(Fe),
  Le = /* @__NO_SIDE_EFFECTS__ */ (e, t, n) => {
    let r = t - e;
    return r === 0 ? 1 : (n - e) / r;
  },
  Re = class {
  ...
  R = /* @__NO_SIDE_EFFECTS__ */ (e) => e * 1e3,
  z = /* @__NO_SIDE_EFFECTS__ */ (e) => e / 1e3;
//#endregion
...
function Ke(e, t, n, r, i) {
  let a,
    o,
    s = 0;
  do ((o = t + (n - t) / 2), (a = Ue(o, r, i) - e), a > 0 ? (n = o) : (t = o));
...
var Je = (e) => (t) => (t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2),
  Ye = (e) => (t) => 1 - e(1 - t),
  Xe = /*@__PURE__*/ qe(0.33, 1.53, 0.69, 0.99),
  Ze = /*@__PURE__*/ Ye(Xe),
  Qe = /*@__PURE__*/ Je(Ze),
  $e = (e) =>
    e >= 1 ? 1 : (e *= 2) < 1 ? 0.5 * Ze(e) : 0.5 * (2 - 2 ** (-10 * (e - 1))),
  et = (e) => 1 - Math.sin(Math.acos(e)),
  tt = Ye(et),
  nt = Je(et),
  rt = /*@__PURE__*/ qe(0.42, 0, 1, 1),
  it = /*@__PURE__*/ qe(0, 0, 0.58, 1),
  at = /*@__PURE__*/ qe(0.42, 0, 0.58, 1),
...
var ct = (e) => Array.isArray(e) && typeof e[0] == "number",
  lt = {
    linear: L,
    easeIn: rt,
    easeInOut: at,
  ...
  let u = {
    ...
    process: (e) => {
      ...
      ((n = r),
        (r = o),
        n.forEach(l),
        t && pt.value && pt.value.frameloop[t].push(c),
        (c = 0),
        n.clear(),
        (i = !1),
        a && ((a = !1), u.process(e)));
...
function gt(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = ft.reduce((e, n) => ((e[n] = mt(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
    ...
    h = () => {
      ...
      ((n = !1),
        a ||
          (i.delta = r ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, ht), 1)),
        (i.timestamp = o),
        (i.isProcessing = !0),
        s.process(i),
        c.process(i),
...
var {
    ...
    typeof requestAnimationFrame < "u" ? requestAnimationFrame : L,
    !0,
  ),
  yt;
function bt() {
...
var H = {
    now: () => (
      yt === void 0 &&
        H.set(
          V.isProcessing || Ae.useManualTiming
            ? V.timestamp
            : performance.now(),
        ),
      yt
  ...
  Ct = /*@__PURE__*/ St("--"),
  wt = /*@__PURE__*/ St("var(--"),
  Tt = (e) => (wt(e) ? Et.test(e.split("/*")[0].trim()) : !1),
  Et =
...
var Pt =
  ...
  Ft = (e, t) => (n) =>
    !!(
      ...
      (t && !Nt(n) && Object.prototype.hasOwnProperty.call(n, t))
    ),
  It = (e, t, n) => (r) => {
...
var Vt = {
  ...
  G = {
    ...
    parse: (e) =>
      zt.test(e) ? zt.parse(e) : qt.test(e) ? qt.parse(e) : Vt.parse(e),
    transform: (e) =>
      typeof e == "string"
        ? e
...
function Yt(e) {
  return (
    isNaN(e) &&
    typeof e == "string" &&
    (e.match(Mt)?.length || 0) + (e.match(Jt)?.length || 0) > 0
  );
}
var Xt = "number",
  Zt = "color",
  ...
  return {
    ...
    split: t
      .replace(
        ...
        (e) => (
          G.test(e)
            ? (r.color.push(a), i.push(Zt), n.push(G.parse(e)))
            : e.startsWith($t)
              ? (r.var.push(a), i.push(Qt), n.push(e))
...
var sn = (e) =>
  ...
  cn = (e, t) =>
    typeof e == "number" ? (t?.trim().endsWith("/") ? e : 0) : sn(e);
function ln(e) {
  let t = nn(e);
...
var _n = (e, t) => {
    ...
    let i = { ...n };
    return (e) => (
      (i.red = pn(n.red, r.red, e)),
      (i.green = pn(n.green, r.green, e)),
      (i.blue = pn(n.blue, r.blue, e)),
...
function Cn(e, t) {
  let n = {
    ...
    r = {};
  for (let i in n)
    e[i] !== void 0 && t[i] !== void 0 && (r[i] = xn(e[i])(e[i], t[i]));
  return (e) => {
...
var Tn = (e, t) => {
  ...
  return r.indexes.var.length === i.indexes.var.length &&
    ...
    ? (vn.has(e) && !i.values.length) || (vn.has(t) && !r.values.length)
      ? yn(e, t)
      : Ie(Sn(wn(r, i), i.values), n)
    : (ke(
        !0,
...
function In({
  ...
  let i, a;
  ke(
    e <= /* @__PURE__ */ R(J.maxDuration),
    "Spring duration must be 10 seconds or less",
    "spring-duration-limit",
  );
  let o = 1 - t;
  ((o = F(J.minDamping, J.maxDamping, o)),
    (e = F(J.minDuration, J.maxDuration, /* @__PURE__ */ z(e))),
    o < 1
      ? ((i = (t) => {
          let r = t * o,
            i = r * e,
  ...
  if (!zn(e, Rn) && zn(e, Ln))
    if (((t.velocity = 0), e.visualDuration)) {
      let n = e.visualDuration,
        r = (2 * Math.PI) / (n * 1.2),
        i = r * r,
        a = 2 * F(0.05, 1, 1 - (e.bounce || 0)) * Math.sqrt(i);
      t = {
        ...t,
        mass: J.mass,
        stiffness: i,
...
function Vn(e = J.visualDuration, t = J.bounce) {
  ...
  let T = {
    ...
    toString: () => {
      let e = Math.min(An(T), kn),
        t = On((t) => T.next(e * t).value, e, 30);
      return e + "ms " + t;
    },
    toTransition: () => {},
  };
...
Vn.applyToOptions = (e) => {
  ...
  return (
    (e.ease = t.ease),
    (e.duration = /* @__PURE__ */ R(t.duration)),
    (e.type = "keyframes"),
    e
  );
};
...
function Zn({
  ...
  let i = ot(r) ? r.map(dt) : dt(r),
    a = {
      done: !1,
      value: t[0],
    },
    o = Kn(Yn(n && n.length === t.length ? n : Jn(t), e), t, {
      ease: Array.isArray(i) ? i : Xn(t, i),
    });
  return {
  ...
  ir = class extends nr {
    ...
    initAnimation() {
      ...
      (process.env.NODE_ENV !== "production" &&
        ...
        s !== Zn &&
          typeof o[0] != "number" &&
          ((this.mixKeyframes = Ie(rr, En(o[0], o[1]))), (o = [0, 100])));
      let c = s({
        ...e,
        keyframes: o,
      });
    ...
    tick(e, t = !1) {
      ...
      return (
        S && p !== Wn && (b.value = $n(l, this.options, h, this.speed)),
        m && m(b.value),
        S && this.finish(),
        b
      );
    ...
    set speed(e) {
      ...
      (t && this.driver && this.updateTime(H.now()),
        ...
        t && this.driver && (this.time = /* @__PURE__ */ z(this.currentTime)));
    }
    play() {
...
var or = (e) => (e * 180) / Math.PI,
  sr = (e) => lr(or(Math.atan2(e[1], e[0]))),
  cr = {
    x: 4,
    y: 5,
    translateX: 4,
  ...
  lr = (e) => ((e %= 360), e < 0 && (e += 360), e),
  ur = sr,
  dr = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1]),
  fr = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5]),
  pr = {
    x: 12,
    y: 13,
    z: 14,
...
var vr = [
  ...
  yr = /* @__PURE__ */ new Set(vr),
  br = (e) => e === Ot || e === W,
  xr = /* @__PURE__ */ new Set(["x", "y", "z"]),
...
function kr() {
  if (Dr) {
    let e = Array.from(Tr).filter((e) => e.needsMeasurement),
...
var Mr = class {
    ...
    scheduleResolve() {
      ((this.state = "scheduled"),
        this.isAsync
          ? (Tr.add(this),
            Er || ((Er = !0), B.read(Ar), B.resolveKeyframes(kr)))
...
var Lr = /* @__PURE__ */ Ir(
  ...
  zr = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`,
  Br = {
    linear: "linear",
    ease: "ease",
    easeIn: "ease-in",
...
var Gr = class extends nr {
    ...
    set time(e) {
      ...
      ((this.manualStartTime = null),
        (this.finishedTime = null),
        (this.animation.currentTime = /* @__PURE__ */ R(e)),
  ...
  Xr = class extends Gr {
    ...
    updateMotionValue(e) {
      ...
      let o = new ir({
        ...
        s = Math.max(Yr, H.now() - this.startTime),
        c = F(0, Yr, s - Yr),
        l = o.sample(s).value,
        { name: u } = this.options;
      (i && u && Pr(i, u, l),
...
function ri(e) {
  for (let t = 0; t < e.length; t++)
    if (typeof e[t] == "string" && ni.test(e[t])) return !0;
  return !1;
}
//#endregion
...
var si = 40,
  ci = class extends nr {
    ...
    onKeyframesResolved(e, t, n, r) {
      ...
      $r(e, i, a, o) ||
        ((u = !1),
        (Ae.instantAnimations || !s) && l?.($n(e, n, t)),
        (e[0] = e[e.length - 1]),
        ei(n),
        (n.repeat = 0));
      let d = {
          startTime: r
            ? this.resolvedAt && this.resolvedAt - this.createdAt > si
              ? this.resolvedAt
              : this.createdAt
            : void 0,
          finalKeyframe: t,
    ...
    get animation() {
      return (
        this._animation || (this.keyframeResolver?.resume(), jr()),
        this._animation
      );
    }
    get duration() {
...
var Ei =
  ...
  (o) => {
    ...
    (Ti(s) || Object.assign(u, xi(e, u)),
      (u.duration &&= /* @__PURE__ */ R(u.duration)),
      (u.repeatDelay &&= /* @__PURE__ */ R(u.repeatDelay)),
      u.from !== void 0 && (u.keyframes[0] = u.from));
    let d = !1;
    if (
      ((u.type === !1 || (u.duration === 0 && !u.repeatDelay)) &&
        (ei(u), u.delay === 0 && (d = !0)),
      (Ae.instantAnimations || Ae.skipAnimations || i?.shouldSkipAnimations) &&
        ((d = !0), ei(u), (u.delay = 0)),
...
function qi(e, t, n = {}) {
  let r = ki(e, t, n.type === "exit" ? e.presenceContext?.custom : void 0),
    { transition: i = e.getDefaultTransition() || {} } = r || {};
  n.transitionOverride && (i = n.transitionOverride);
  let a = r ? () => Promise.all(Ki(e, r, n)) : () => Promise.resolve(),
    o =
...
var fa = /* @__PURE__ */ new Set(["auto", "none", "0"]);
function pa(e, t, n) {
  let r = 0,
    i;
  for (; r < e.length && !i; ) {
    let t = e[r];
    (typeof t == "string" && !fa.has(t) && nn(t).values.length && (i = e[r]),
      r++);
  }
...
var ma = class extends Mr {
  ...
  measureEndState() {
    ...
    let i = n.length - 1,
      a = n[i];
    ((n[i] = wr[t](e.measureViewportBox(), window.getComputedStyle(e.current))),
...
var { schedule: va, cancel: ya } = /* @__PURE__ */ gt(queueMicrotask, !1),
  X = {
    x: !1,
    y: !1,
  };
...
var Ta = (e, t) => (t ? e === t || Ta(e, t.parentElement) : !1),
  Ea = (e) =>
    e.pointerType === "mouse"
      ? typeof e.button != "number" || e.button <= 0
      : e.isPrimary !== !1,
  Da = /* @__PURE__ */ new Set(["BUTTON", "INPUT", "SELECT", "TEXTAREA", "A"]);
function Oa(e) {
  return Da.has(e.tagName) || e.isContentEditable === !0;
}
var ka = /* @__PURE__ */ new Set(["INPUT", "SELECT", "TEXTAREA"]);
function Aa(e) {
      ...
      let a = t(r, e),
        o = (e, t) => {
          (window.removeEventListener("pointerup", s),
            window.removeEventListener("pointercancel", c),
            ja.has(r) && ja.delete(r),
            Fa(e) && typeof a == "function" && a(e, { success: t }));
        },
        s = (e) => {
          o(
            e,
  ...
  return (
    r.forEach((e) => {
      ((n.useGlobalTarget ? window : e).addEventListener("pointerdown", o, i),
        _a(e) &&
          (e.addEventListener("focus", (e) => Pa(e, i)),
          !Oa(e) && !e.hasAttribute("tabindex") && (e.tabIndex = 0)));
    }),
    a
  );
}
  ...
  Va = (e, t, n) => (r, i) =>
    i && i[0]
      ...
      : Ra(r) && "getBBox" in r
        ? r.getBBox()[t]
        : r[n],
  Ha = /*@__PURE__*/ Va("inline", "width", "offsetWidth"),
  Ua = /*@__PURE__*/ Va("block", "height", "offsetHeight");
...
function qa(e, t) {
  ...
  return (
    n.forEach((e) => {
      let n = za.get(e);
      (n || ((n = /* @__PURE__ */ new Set()), za.set(e, n)),
        n.add(t),
        Ba?.observe(e));
    }),
    () => {
...
var Co = class {
    ...
    constructor(
      ...
      ((this.latestValues = c),
        ...
        (this.isControllingVariants = fo(t)),
        (this.isVariantNode = po(t)),
        this.isVariantNode &&
      ...
      ((this.current = e),
        ...
        this.reducedMotionConfig === "never"
          ...
          : this.reducedMotionConfig === "always"
            ...
            : (go.current || vo(), (this.shouldReduceMotion = ho.current)),
        process.env.NODE_ENV !== "production" &&
          Ve(
            this.shouldReduceMotion !== !0,
    ...
    bindToMotionValue(e, t) {
      if (
        ...
        t.accelerate && ti.has(e) && this.current instanceof HTMLElement)
      ) {
        let {
            factory: n,
            keyframes: r,
    ...
    getValue(e, t) {
      ...
      return (
        n === void 0 &&
          t !== void 0 &&
          ((n = Fi(t === null ? void 0 : t, { owner: this })),
          this.addValue(e, n)),
        n
      );
    }
    readValue(e, t) {
      ...
      return (
        n != null &&
          (typeof n == "string" && (je(n) || Ne(n))
            ? (n = parseFloat(n))
            : !no(n) && K.test(t) && (n = da(e, t)),
          this.setBaseTarget(e, Y(n) ? n.get() : n)),
        Y(n) ? n.get() : n
      );
    }
    setBaseTarget(e, t) {
...
function Lo(e, { x: t, y: n }) {
  (Io(e.x, t.translate, t.scale, t.originPoint),
    Io(e.y, n.translate, n.scale, n.originPoint));
}
var Ro = 0.999999999999,
  zo = 1.0000000000001;
  ...
  for (let s = 0; s < i; s++) {
    ...
    (i && i.props.style && i.props.style.display === "contents") ||
      (r &&
        ...
        a.scroll &&
        a !== a.root &&
        (Vo(e.x, -a.scroll.offset.x), Vo(e.y, -a.scroll.offset.y)),
      o && ((t.x *= o.x.scale), (t.y *= o.y.scale), Lo(e, o)),
      r && jo(a.latestValues) && Wo(e, a.latestValues, a.layout?.layoutBox));
  }
...
function Wo(e, t, n) {
  let r = n ?? e;
  (Ho(e.x, Uo(t.x, r.x), t.scaleX, t.scale, t.originX),
    Ho(e.y, Uo(t.y, r.y), t.scaleY, t.scale, t.originY));
}
//#endregion
...
var ds = ["offsetDistance", "offsetPath", "offsetRotate", "offsetAnchor"];
function fs(
  e,
  {
    attrX: t,
...
function Fs(e, t, n, r = 0.5) {
  ((e.origin = r),
    (e.originPoint = q(t.min, t.max, e.origin)),
    (e.scale = $(n) / $(t)),
    (e.translate = q(n.min, n.max, e.origin) - e.originPoint),
    ((e.scale >= As && e.scale <= js) || isNaN(e.scale)) && (e.scale = 1),
    ((e.translate >= Ms && e.translate <= Ns) || isNaN(e.translate)) &&
      (e.translate = 0));
}
function Is(e, t, n, r) {
  (Fs(e.x, t.x, n.x, r ? r.originX : void 0),
    Fs(e.y, t.y, n.y, r ? r.originY : void 0));
}
...
function Vs(e, t, n, r, i) {
  return (
    (e -= t),
    (e = Po(e, 1 / n, r)),
    i !== void 0 && (e = Po(e, 1 / i, r)),
    e
  );
}
function Hs(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
  if (
  ...
  (e === a && (s -= t),
    (e.min = Vs(e.min, t, n, s, i)),
    (e.max = Vs(e.max, t, n, s, i)));
}
...
var Ws = ["x", "scaleX", "originX"],
  Gs = ["y", "scaleY", "originY"];
function Ks(e, t, n, r) {
  (Us(e.x, t, Ws, n ? n.x : void 0, r ? r.x : void 0),
    Us(e.y, t, Gs, n ? n.y : void 0, r ? r.y : void 0));
}
//#endregion
...
var rc = [
  ...
  ic = rc.length,
  ac = (e) => (typeof e == "string" ? parseFloat(e) : e),
  oc = (e) => typeof e == "number" || W.test(e);
function sc(e, t, n, r, i, a) {
  i
    ? ((e.opacity = q(0, n.opacity ?? 1, lc(r))),
      (e.opacityExit = q(t.opacity ?? 1, 0, uc(r))))
...
var lc = /*@__PURE__*/ dc(0, 0.5, tt),
  uc = /*@__PURE__*/ dc(0.5, 0.95, L);
function dc(e, t, n) {
...
var mc = (e, t) => e.depth - t.depth,
  hc = class {
    ...
    forEach(e) {
      (this.isDirty && this.children.sort(mc),
        (this.isDirty = !1),
  ...
  return class {
      ...
      ((this.id = Cc++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            pt.value &&
              (bc.nodes =
                bc.calculatedTargetDeltas =
                bc.calculatedProjections =
                  0),
            this.nodes.forEach(kc),
            this.nodes.forEach(Rc),
            this.nodes.forEach(zc),
            this.nodes.forEach(Ac),
            pt.addProjectionMetrics && pt.addProjectionMetrics(bc));
        }),
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              yc.hasAnimatedSinceResize &&
                ((yc.hasAnimatedSinceResize = !1), this.nodes.forEach(Lc)));
          }));
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({
              ...
              let a = this.options.transition || i.getDefaultTransition() || Kc,
                { onLayoutAnimationStart: o, onLayoutAnimationComplete: s } =
                  i.getProps(),
                c = !this.targetLayout || !Qs(this.targetLayout, r),
                l = !t && n;
              if (
    ...
    update() {
      ...
      ((this.animationCommitId = this.animationId),
        ...
        this.clearAllSnapshots());
      let e = H.now();
      ((V.delta = F(0, 1e3 / 60, e - V.timestamp)),
        (V.timestamp = e),
        (V.isProcessing = !0),
        vt.update.process(V),
        vt.preRender.process(V),
        vt.render.process(V),
        (V.isProcessing = !1));
    }
    didUpdate() {
    ...
    removeElementScroll(e) {
      ...
      for (let n = 0; n < this.path.length; n++) {
        ...
        r !== this.root &&
          i &&
          a.layoutScroll &&
          (i.wasRoot && Q(t, e), Vo(t.x, i.offset.x), Vo(t.y, i.offset.y));
      }
      return t;
    }
    applyTransform(e, t = !1, n) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        (!t &&
          ...
          n.scroll &&
          n !== n.root &&
          (Vo(r.x, -n.scroll.offset.x), Vo(r.y, -n.scroll.offset.y)),
          jo(n.latestValues) && Wo(r, n.latestValues, n.layout?.layoutBox));
      }
      return (
        jo(this.latestValues) &&
          Wo(r, this.latestValues, this.layout?.layoutBox),
        r
      );
    }
    removeTransform(e) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        let r;
        (n.instance &&
          (Ao(n.latestValues) && n.updateSnapshot(),
          (r = Z()),
          Q(r, n.measurePageBox())),
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          this.relativeParent.target
            ...
            : this.targetDelta
              ? (this.resumingFrom
                ...
                Lo(this.target, this.targetDelta))
              : Q(this.target, this.layout.layoutBox),
          this.attemptToResolveRelativeTarget &&
          ...
          pt.value && bc.calculatedTargetDeltas++));
    }
    ...
    calcProjection() {
      ...
      let a = this.treeScale.x,
        o = this.treeScale.y;
      (Bo(this.layoutCorrected, this.treeScale, this.path, t),
        e.layout &&
          !e.target &&
          (this.treeScale.x !== 1 || this.treeScale.y !== 1) &&
          ((e.target = e.layout.layoutBox), (e.targetWithTransforms = Z())));
      let { target: s } = e;
      if (!s) {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        : (ks(this.prevProjectionDelta.x, this.projectionDelta.x),
          ks(this.prevProjectionDelta.y, this.projectionDelta.y)),
        Is(this.projectionDelta, this.layoutCorrected, s, this.latestValues),
        (this.treeScale.x !== a ||
          this.treeScale.y !== o ||
        ...
        pt.value && bc.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
      ...
      ((this.mixTargetDelta = (t) => {
        ...
        (Hc(a.x, e.x, n),
          ...
          this.relativeTarget &&
            ...
            Wc(this.relativeTarget, this.relativeTargetOrigin, o, n),
            d && Xs(this.relativeTarget, d) && (this.isProjectionDirty = !1),
            (d ||= Z()),
            Q(d, this.relativeTarget)),
          s &&
            ((this.animationValues = i), sc(i, r, this.latestValues, n, u, l)),
          this.root.scheduleUpdateProjection(),
          this.scheduleRender(),
    ...
    startAnimation(e) {
      (this.notifyListeners("animationStart"),
        ...
        (this.pendingAnimation &&= (_t(this.pendingAnimation), void 0)),
        (this.pendingAnimation = B.update(() => {
          ((yc.hasAnimatedSinceResize = !0),
            xt.layout++,
            (this.motionValue ||= Fi(0)),
            this.motionValue.jump(0, !1),
            (this.currentAnimation = fc(this.motionValue, [0, 1e3], {
              ...e,
              velocity: 0,
              isSync: !0,
              onUpdate: (t) => {
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(Sc),
        this.currentAnimation.stop()),
        this.completeAnimation());
    }
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        if (
          ...
          this.layout &&
          r &&
          Zc(this.options.animationType, this.layout.layoutBox, r.layoutBox)
        ) {
          n = this.target || Z();
        ...
        (Q(t, n),
          Wo(t, i),
          Is(this.projectionDeltaWithTransform, this.layoutCorrected, t, i));
      }
    }
    registerSharedNode(e, t) {
      (this.sharedNodes.has(e) || this.sharedNodes.set(e, new vc()),
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < xc.length; t++)
        (wc(`rotate${xc[t]}`, e, r, this.animationValues),
          wc(`skew${xc[t]}`, e, r, this.animationValues));
      e.render();
      for (let t in r)
    ...
    applyProjectionStyles(e, t) {
      ...
      if (this.needsReset) {
        ((this.needsReset = !1),
          (e.visibility = ""),
          (e.opacity = ""),
          (e.pointerEvents = _c(t?.pointerEvents) || ""),
      ...
      for (let t in ts) {
        ...
        let { correct: n, applyTo: o, isCSSVariable: s } = ts[t],
      ...
      this.options.layoutId &&
        (e.pointerEvents = r === this ? _c(t?.pointerEvents) || "" : "none");
    }
    clearSnapshot() {
...
var Kc = {
  ...
  Jc = qc("applewebkit/") && !qc("chrome/") ? Math.round : L;
function Yc(e) {
...
function Zc(e, t, n) {
  return (
    e === "position" || (e === "preserve-aspect" && !Ps($s(t), $s(n), 0.2))
  );
}
function Qc(e) {
  ...
  getSnapshotBeforeUpdate(e) {
    ...
    if (
      ...
      let e = t.offsetParent,
        n = (_a(e) && e.offsetWidth) || 0,
        r = (_a(e) && e.offsetHeight) || 0,
...
var pl = ({
    ...
    let [u, d] = ul(o),
      ...
      m = j(!0),
      h = j(f),
      g = Ce(() => /* @__PURE__ */ new Map()),
      _ = j(/* @__PURE__ */ new Set()),
      [v, y] = M(f),
      [b, x] = M(f);
    we(() => {
...
function Rl(e, t, n, r) {
  let i = ye(() => {
    let n = Ll();
    return (
      fs(n, t, ms(r), e.transformTemplate, e.style),
      {
        ...n.attrs,
        style: { ...n.style },
      }
...
function Vl(e, t, n, { latestValues: r }, i, a = !1, o) {
  let s = ((o ?? Bl(e)) ? Rl : Il)(t, r, i, e),
    c = Dl(t, typeof e == "string", a),
    l =
      e === ue
        ? {}
        : {
...
function Ql(e, t, n, r) {
  ...
  ((e.projection = new n(
    e.latestValues,
    t["data-framer-portal-id"] ? void 0 : $l(e.parent),
  )),
...
function eu(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  ...
  function s(n, s) {
    ...
    if (!u && typeof window < "u") {
      ...
      let t = ru(l);
      ((c = t.MeasureLayout),
        (d.visualElement = Zl(e, f, l, i, t.ProjectionNode, a)));
    }
    return P(Ol.Provider, {
      ...
      children: [
        c && d.visualElement
          ...
          : null,
        Vl(e, n, Jl(f, d.visualElement, s), f, u, t, a),
      ],
    });
  }
...
function nu(e, t) {
  ...
  if (process.env.NODE_ENV !== "production" && t && n) {
    ...
    e.ignoreStrict
      ? ke(!1, t, "lazy-strict-mode")
      : I(!1, t, "lazy-strict-mode");
  }
}
function ru(e) {
...
function iu(e, t) {
  ...
  return new Proxy(
    (e, t) => (
      process.env.NODE_ENV !== "production" &&
        Ve(!1, "motion() is deprecated. Use motion.create() instead."),
      r(e, t)
    ),
    {
      get: (i, a) =>
        a === "create"
          ? r
          : (n.has(a) || n.set(a, eu(a, void 0, e, t)), n.get(a)),
    },
  );
}
//#endregion
...
var au = (e, t) =>
    (t.isSVG ?? Bl(e)) ? new _s(t) : new as(t, { allowProjection: e !== ue }),
  ou = class extends To {
    constructor(e) {
...
var fu = ({ current: e }) => (e ? e.ownerDocument.defaultView : null),
  pu = (e, t) => Math.abs(e - t);
function mu(e, t) {
  let n = pu(e.x, t.x),
    r = pu(e.y, t.y);
...
var hu = /*#__PURE__*/ new Set(["auto", "scroll"]),
  gu = class {
    constructor(
      e,
      t,
      ...
      if (
        ...
        (this.updatePoint = () => {
          ...
          this.lastRawMoveEventInfo &&
            (this.lastMoveEventInfo = _u(
              this.lastRawMoveEventInfo,
              this.transformPagePoint,
            ));
          let e = yu(this.lastMoveEventInfo, this.history),
        ...
        (this.handlePointerMove = (e, t) => {
          ((this.lastMoveEvent = e),
            ...
            (this.lastMoveEventInfo = _u(t, this.transformPagePoint)),
      ...
      let s = _u(lu(e), this.transformPagePoint),
        { point: c } = s,
        { timestamp: l } = V;
      this.history = [
        {
      ...
      (u && u(e, yu(s, this.history)),
        (this.removeListeners = Ie(
          du(this.contextWindow, "pointermove", this.handlePointerMove),
          du(this.contextWindow, "pointerup", this.handlePointerUp),
          du(this.contextWindow, "pointercancel", this.handlePointerUp),
        )),
    ...
    startScrollTracking(e) {
      ...
      for (; t; ) {
        ...
        ((hu.has(e.overflowX) || hu.has(e.overflowY)) &&
...
function Su(e, t) {
  ...
  for (
    ;
    n >= 0 && ((r = e[n]), !(i.timestamp - r.timestamp > /* @__PURE__ */ R(t)));
  )
    n--;
  if (!r)
    return {
  ...
  r === e[0] &&
    e.length > 2 &&
    i.timestamp - r.timestamp > /* @__PURE__ */ R(t) * 2 &&
    (r = e[1]);
...
function Ou(e, t) {
  ...
  return (
    i > r
      ? (n = /* @__PURE__ */ Le(t.min, t.max - r, e.min))
      : r > i && (n = /* @__PURE__ */ Le(e.min, e.max - i, t.min)),
    F(0, 1, n)
  );
}
function ku(e, t) {
...
var Pu = /* @__PURE__ */ new WeakMap(),
  Fu = class {
      ...
      let i = (e) => {
        ...
        a = (e, t) => {
          ...
          ((this.latestPointerEvent = e),
            ...
            Vi(this.visualElement, "transform"));
    ...
    updateAxis(e, t, n) {
      ...
      (this.constraints &&
        this.constraints[e] &&
        (a = Cu(a, this.constraints[e], this.elastic[e])),
        i.set(a));
    }
    resolveConstraints() {
        ...
        r !== this.constraints &&
          ...
          tc((e) => {
            this.constraints !== !1 &&
              ...
              (this.constraints[e] = ku(n.layoutBox[e], this.constraints[e]));
          }));
    }
    ...
    startAxisValueAnimation(e, t) {
      ...
      return (
        Vi(this.visualElement, e),
        n.start(Ei(e, n, 0, t, this.visualElement, !1))
      );
    }
    stopAnimation() {
    ...
    addListeners() {
      ...
      (i && !i.layout && (i.root && i.root.updateScroll(), i.updateLayout()),
        B.read(r));
      let o = pc(window, "resize", () => this.scalePositionWithinConstraints()),
...
var Bu = class extends To {
  ...
  Hu = class extends To {
    ...
    mount() {
      this.removePointerDownListener = du(
        this.node.current,
        "pointerdown",
...
var Ju = class extends To {
    mount() {
      ...
      e &&
        (this.unmount = wa(
          e,
          (e, t) => (qu(this.node, t, "Start"), (e) => qu(this.node, e, "End")),
        ));
    }
    unmount() {}
  },
  Yu = class extends To {
    ...
    mount() {
      this.unmount = Ie(
        pc(this.node.current, "focus", () => this.onFocus()),
        pc(this.node.current, "blur", () => this.onBlur()),
      );
    }
    unmount() {}
  };
...
var Zu = class extends To {
    mount() {
      ...
      this.unmount = La(
        e,
        (e, t) => (
          Xu(this.node, t, "Start"),
          (e, { success: t }) => Xu(this.node, e, t ? "End" : "Cancel")
        ),
        {
          useGlobalTarget: t,
...
function nd({ root: e, ...t }) {
  ...
  return (
    r[i] ||
      (r[i] = new IntersectionObserver(td, {
        root: e,
        ...t,
      })),
    r[i]
...
var id = {
  ...
  ad = class extends To {
    ...
    update() {
      ...
      ["amount", "margin", "root"].some(od(e, t)) && this.startObserver();
    }
    unmount() {
...
function pd(e, t, n, r) {
  ...
  if (n !== void 0 && !Array.isArray(n) && typeof t != "function")
    return hd(e, t, n, r);
  let i = typeof t == "function" ? t : eo(t, n, r),
    a = Array.isArray(e) ? md(e, i) : md([e], ([e]) => i(e)),
    ...
    s.forEach((e, r) => {
      for (let i in e) {
        ...
        for (let e = 0; e < a.length; e++) {
          ...
          (s.push(n),
            c.push(/* @__PURE__ */ Le(0, f, t)),
            l.push(r || "easeOut"));
        }
        (c[0] !== 0 && (c.unshift(0), s.unshift(s[0]), l.unshift(wd)),
...
function Gd() {
  let e = C((e) => e.osTheme),
    t = C((e) => e.resolvedColorScheme),
    n = C((e) => e.glassEnabled),
    r = Wd[e];
  return {
    osTheme: e,
    colorScheme: t,
...
function tf() {
  let [e, t] = M(""),
    [n, r] = M(""),
    i =
      C((e) => e.wallpaperTextTheme) === "light"
        ? "text-black/80"
        : "text-white/85";
  return (
    A(() => {
...
df.displayName = uf;
var ff = "PopoverTrigger",
  pf = E.forwardRef((t, n) => {
    let { __scopePopover: i, ...a } = t,
      o = cf(ff, i),
      s = of(i),
      c = r(n, o.triggerRef),
      l = /* @__PURE__ */ N(u.button, {
        type: "button",
...
pf.displayName = ff;
var mf = "PopoverPortal",
  [hf, gf] = rf(mf, { forceMount: void 0 }),
  _f = (e) => {
...
_f.displayName = mf;
var vf = "PopoverContent",
  yf = E.forwardRef((e, t) => {
    let n = gf(vf, e.__scopePopover),
      { forceMount: r = n.forceMount, ...i } = e,
      a = cf(vf, e.__scopePopover);
    return /* @__PURE__ */ N(d, {
      present: r || a.open,
      children: a.modal
        ? /* @__PURE__ */ N(xf, {
...
yf.displayName = vf;
var bf = x("PopoverContent.RemoveScroll"),
  xf = E.forwardRef((t, n) => {
    let i = cf(vf, t.__scopePopover),
      a = E.useRef(null),
      o = r(n, a),
      s = E.useRef(!1);
    return (
  ...
  Sf = E.forwardRef((e, t) => {
    let n = cf(vf, e.__scopePopover),
      r = E.useRef(!1),
      i = E.useRef(!1);
    return /* @__PURE__ */ N(Cf, {
      ...e,
      ref: t,
      trapFocus: !1,
  ...
  return r
    ? (e.shaderSource(r, n),
      ...
      e.getShaderParameter(r, e.COMPILE_STATUS)
        ? r
        : (console.warn(
            "[GlassShimmer] Shader compile error:",
...
function If(e, t, n) {
  let r = Ff(e, e.VERTEX_SHADER, t),
    i = Ff(e, e.FRAGMENT_SHADER, n);
  if (!r || !i) return null;
  ...
  return a
    ? (e.attachShader(a, r),
      ...
      e.getProgramParameter(a, e.LINK_STATUS)
        ? a
        : (console.warn(
            "[GlassShimmer] Program link error:",
...
function Lf(e) {
  A(() => {
    ...
    if (!r) return;
    n.useProgram(r);
    let i = new Float32Array([-1, -1, 1, -1, -1, 1, 1, 1]),
      a = n.createBuffer();
    ...
    let s = n.getUniformLocation(r, "u_time"),
      c = n.getUniformLocation(r, "u_resolution");
    ...
    let l,
      u = (e) => {
        ...
        ((t.width !== i || t.height !== a) && ((t.width = i), (t.height = a)),
          n.viewport(0, 0, t.width, t.height),
          n.clearColor(0, 0, 0, 0),
          n.clear(n.COLOR_BUFFER_BIT),
          n.uniform1f(s, e * 0.001),
          n.uniform2f(c, t.width, t.height),
...
function zf() {
  ...
  return (
    A(() => {
      let t = e.current;
      if (!t) return;
      let r = "lg-distort-" + Math.random().toString(36).substring(2, 9),
        i = () => {
          let e = t.clientWidth,
            i = t.clientHeight;
          if (e === 0 || i === 0) return;
          let a = window.getComputedStyle(t),
            o = parseFloat(a.borderRadius) || 14,
            s = Math.min(24, Math.min(e, i) / 4),
          ...
          let d = u.getContext("2d"),
            f = l.createImageData(e, i),
            p = d.createImageData(e, i),
            m = f.data,
            h = p.data,
            g = o,
            _ = s;
          for (let t = 0; t < i; t++)
            for (let n = 0; n < e; n++) {
              let r = (t * e + n) * 4,
                ...
                l = Math.max(s, 0),
                u = Math.max(c, 0),
                d = Math.sqrt(l * l + u * u) + Math.min(Math.max(s, c), 0) - g;
              if (d > 0)
                ((m[r] = 128),
                  (m[r + 1] = 128),
                  (m[r + 2] = 0),
                ...
                if (s > 0 && c > 0) {
                  ...
                  s > c
                    ? ((n = a >= 0 ? 1 : -1), (i = 0))
                    : ((n = 0), (i = o >= 0 ? 1 : -1));
                let l = Math.sin(t * Math.PI),
                  u = -n * l,
                  f = -i * l;
                ((m[r] = Math.round(128 + 127 * u)),
                  (m[r + 1] = Math.round(128 + 127 * f)),
                  (m[r + 2] = 0),
                  (m[r + 3] = 255));
                let p = -(n * -0.707 + i * -0.707),
                  g = (0.2 + 0.8 * Math.max(0, p)) * (1 - t);
                ((h[r] = 255),
                  (h[r + 1] = 255),
                  (h[r + 2] = 255),
                  (h[r + 3] = Math.round(255 * g)));
              }
            }
...
function Hf({
  ...
  let { isGlass: c, colorScheme: l } = Gd(),
    u = r === void 0 ? c : r,
    d = C((e) => e.glassMode),
    f = i ?? Bf[n],
    p = f ? { borderRadius: f } : {},
    m = Vf[n],
    { elementRef: h, maps: g } = zf(),
    _ = E.useCallback(
      (e) => {
        ((h.current = e),
          ...
          children: [
            ...
            u &&
              ...
              /* @__PURE__ */ N("div", {
                "aria-hidden": !0,
                className:
                  "absolute inset-y-0 left-0 w-px pointer-events-none z-10",
                style: {
                  background:
            ...
            u &&
              /* @__PURE__ */ N(Rf, {
                className:
                  "absolute inset-0 w-full h-full z-30 opacity-25 pointer-events-none",
              }),
            u &&
              g &&
              /* @__PURE__ */ N("svg", {
...
function Uf() {
  let [e, t] = M(!1),
    n = C((e) => e.colorScheme),
    r = C((e) => e.setColorScheme),
    i = C((e) => e.glassEnabled),
    a = C((e) => e.setGlassEnabled),
    o = C((e) => e.wallpaperTextTheme),
    [s, c] = M(75),
    [l, u] = M(80),
    d =
      o === "light"
    ...
    f = o === "light" ? "text-black/90" : "text-white/90",
    p = o === "light" ? "text-black/55" : "text-white/55",
    m = o === "light" ? "text-black/45" : "text-white/45",
    h = o === "light" ? "bg-black/5" : "bg-white/5",
    g =
      o === "light"
          ...
          children: /* @__PURE__ */ N(Hf, {
            ...
            children: /* @__PURE__ */ P("div", {
              ...
              children: [
                /* @__PURE__ */ P("div", {
                  className: w(
                    "rounded-[var(--radius-input)] p-3 flex items-center gap-2",
                    h,
                  ),
                  children: [
                    /* @__PURE__ */ N("div", {
                      className:
                        "w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center shrink-0",
                      children: /* @__PURE__ */ N(ef, {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ N("div", {
                      ...
                      children: [
                        {
                          id: "light",
                          icon: /* @__PURE__ */ N(re, { className: "w-3 h-3" }),
                        },
                        {
                          id: "auto",
                ...
                /* @__PURE__ */ P("div", {
                  className: w(
                    "col-span-2 rounded-[var(--radius-input)] p-3",
                    h,
                  ),
                  children: [
                    /* @__PURE__ */ P("div", {
                ...
                /* @__PURE__ */ P("div", {
                  className: w(
                    "col-span-2 rounded-[var(--radius-input)] p-3 flex items-center justify-between",
                    h,
                  ),
                  children: [
                    /* @__PURE__ */ N("p", {
                    ...
                    /* @__PURE__ */ N("button", {
                      ...
                      className: w(
                        ...
                        i ? "bg-blue-500" : "bg-neutral-300 dark:bg-white/15",
                      ),
...
function qf({ label: e, shortcut: t, disabled: n, onClick: r }) {
...
function Jf() {
  return /* @__PURE__ */ N("div", {
    className: "my-1 mx-2 h-px bg-black/10 dark:bg-white/10",
  });
}
function Yf(e, t) {
  let n = {
...
function Zf({ item: e, t, onSelect: n }) {
  let [r, i] = M(!1),
    [a, o] = M(null),
    s = j(null),
    c = j(null),
    l = !!e.children && e.children.length > 0,
    u = O(() => {
      ...
      ? /* @__PURE__ */ P("div", {
          ...
          children: [
            /* @__PURE__ */ P("button", {
              ...
              children: [
                /* @__PURE__ */ N("span", { children: Xf(e.label, t) }),
                /* @__PURE__ */ N(ee, {
                  className: "w-3.5 h-3.5 ml-6 opacity-60",
                }),
              ],
            }),
            r &&
    ...
    : xe(
        /* @__PURE__ */ P("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ P("div", {
              className:
                "relative flex flex-col items-center bg-neutral-100/97 dark:bg-[#1c1c1e]/97 backdrop-blur-2xl rounded-(--radius-window) shadow-2xl border border-black/10 dark:border-white/8 w-80 overflow-hidden pointer-events-auto",
              ...
              children: [
                /* @__PURE__ */ N("div", {
                  className:
                    "w-full flex items-center gap-2 px-4 pt-3.5 pb-2 border-b border-black/8 dark:border-white/8 cursor-move select-none bg-neutral-200/60 dark:bg-white/5",
                  onPointerDown: o,
                  onMouseEnter: () => i(!0),
                  onMouseLeave: () => i(!1),
                  children: /* @__PURE__ */ P("div", {
                    ...
                    children: [
                      /* @__PURE__ */ N("button", {
                        onClick: e,
                        className:
                          "w-3.5 h-3.5 rounded-full flex items-center justify-center pointer-events-auto cursor-pointer",
                ...
                /* @__PURE__ */ P("div", {
                  className:
                    "flex flex-col items-center px-8 pt-6 pb-7 gap-2 select-none",
                  children: [
                    /* @__PURE__ */ N("div", {
                      className:
                        "w-20 h-20 mb-1 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-4xl font-bold text-white shadow-lg",
                      children: "S",
                    }),
                    /* @__PURE__ */ N("div", {
                      className:
                        "text-[17px] font-bold text-black/90 dark:text-white/90",
                      children: "Skyline",
                    }),
                    /* @__PURE__ */ N("div", {
                    ...
                    /* @__PURE__ */ N("div", {
                      className:
                        "w-full h-px bg-black/10 dark:bg-white/10 my-2",
                    }),
                    /* @__PURE__ */ P("div", {
                      className:
                        "text-[12px] text-black/45 dark:text-white/45 text-center leading-relaxed",
                      children: [
                    ...
                    /* @__PURE__ */ P("a", {
                      ...
                      className:
                        "flex items-center gap-1.5 text-[12px] text-black/50 dark:text-white/50 hover:text-black/80 dark:hover:text-white/80 transition-colors mt-1 pointer-events-auto",
                      children: [
                        /* @__PURE__ */ N("svg", {
                          viewBox: "0 0 24 24",
                    ...
                    /* @__PURE__ */ N("div", {
                      className:
                        "text-[11px] text-black/35 dark:text-white/35 text-center mt-1",
...
function ep({ activeId: e, setActiveId: t }) {
  let n = e === "apple",
    r = O(
      (e) => {
  ...
  return /* @__PURE__ */ P(be, {
    children: [
      /* @__PURE__ */ N("button", {
        ...
        className: w(Kf, n ? "bg-accent-active text-white" : i),
        children: /* @__PURE__ */ N("span", {
      ...
      a && /* @__PURE__ */ N($f, { onClose: () => o(!1) }),
    ],
  });
}
//#endregion
//#region src/components/menubar/AppNameDropdown.tsx
function tp({ appConfig: e, appId: t, activeId: n, setActiveId: r }) {
  let i = n === "app-name",
    a = O(
      (e) => {
    ...
    c = C((e) => e.closeWindow),
    { t: l, getAppName: u } = oe(),
    d = e ? u(e.id, e.name) : l.appNameFinder,
    f = O(() => a(!1), [a]),
    p = (e) => {
      t &&
    ...
    children: [
      /* @__PURE__ */ N("button", {
        ...
        className: w(
          Kf,
          "font-semibold",
          i ? "bg-accent-active text-white" : o,
        ),
        children: /* @__PURE__ */ N("span", {
  ...
  return /* @__PURE__ */ P(be, {
    children: [
      /* @__PURE__ */ N("button", {
        ...
        className: w(Kf, o ? "bg-accent-active text-white" : c),
        children: Yf(e, u),
      }),
      /* @__PURE__ */ N(Qf, {
        anchorRef: l,
...
function rp({ onSpotlight: e } = {}) {
  let t = C((e) => e.activeAppId),
    n = C((e) => e.apps),
    r = t ? n[t] : null,
    i = r?.menuBarMenus ?? S,
    a = C((e) => e.wallpaperTextTheme),
    o = w(
      Kf,
      "px-2",
      a === "light"
...
var ip = {
  Finder: D(() =>
    import("./Finder-gAzk-qeN.js").then((e) => ({ default: e.Finder })),
  ),
  Terminal: D(() =>
    import("./Terminal-BFIScMKe.js").then((e) => ({ default: e.Terminal })),
  ),
  Settings: D(() =>
    import("./Settings-EKaEB-c0.js").then((e) => ({ default: e.Settings })),
  ),
  Browser: D(() =>
    import("./Browser-DgZHqpHg.js").then((e) => ({ default: e.Browser })),
  ),
  TextEditor: D(() =>
    import("./TextEditor-DvB3D_bZ.js").then((e) => ({ default: e.TextEditor })),
  ),
  Clock: D(() =>
    import("./Clock-0pbhFf7x.js").then((e) => ({ default: e.Clock })),
  ),
  Notes: D(() =>
    import("./Notes-gy8L9RJK.js").then((e) => ({ default: e.Notes })),
  ),
  Photos: D(() =>
    import("./Photos-BsOMZ1K_.js").then((e) => ({ default: e.Photos })),
  ),
  Music: D(() =>
    import("./Music-B_4gUAv9.js").then((e) => ({ default: e.Music })),
  ),
  Calendar: D(() =>
    import("./Calendar-DZK0kYfd.js").then((e) => ({ default: e.Calendar })),
  ),
  Messages: D(() =>
    import("./Messages-C9NTv7c4.js").then((e) => ({ default: e.Messages })),
  ),
  IframeApp: D(() =>
    import("./IframeApp-CiFT-Yhs.js").then((e) => ({ default: e.IframeApp })),
  ),
  MdxApp: D(() =>
    import("./MdxApp-kzj2xGeR.js").then((e) => ({ default: e.MdxApp })),
  ),
};
function ap() {
  return /* @__PURE__ */ N("div", {
    ...
    children: /* @__PURE__ */ N(Jd, {
      className: "w-6 h-6 animate-spin text-black/30 dark:text-white/30",
    }),
  });
}
function op({ appId: e, windowId: t }) {
  ...
  if (!n)
    return /* @__PURE__ */ P("div", {
      className:
        "flex items-center justify-center h-full text-sm text-black/40 dark:text-white/40",
      children: ["App not found: ", e],
    });
  if (n.render) {
    let r = n.render;
    return /* @__PURE__ */ N(de, {
      fallback: /* @__PURE__ */ N(ap, {}),
              ...
              children: [
                ...
                /* @__PURE__ */ P(
                  ld.div,
                  {
                    ...
                    className:
                      "fixed bottom-0 left-0 right-0 z-[2001] max-h-[75vh] overflow-y-auto rounded-t-2xl bg-white dark:bg-neutral-900 shadow-2xl",
                    children: [
                      /* @__PURE__ */ N("div", {
                        className:
                          "sticky top-0 flex justify-center py-2 bg-white dark:bg-neutral-900",
                        children: /* @__PURE__ */ N("div", {
                          className:
                            "w-10 h-1 rounded-full bg-black/20 dark:bg-white/25",
                        }),
                      }),
                      /* @__PURE__ */ N("div", {
                        className: "px-4 pb-8",
                          ...
                          /* @__PURE__ */ P(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ N("div", {
                                  className:
                                    "px-1 py-1.5 text-[11px] font-semibold uppercase tracking-wider text-black/40 dark:text-white/40",
                                  children: Yf(e.label, i),
                                }),
                                /* @__PURE__ */ N("div", {
                                  className:
                                    "rounded-xl overflow-hidden bg-black/[0.03] dark:bg-white/[0.06]",
                                  children: e.items.map((e, t) =>
                                    e.separator
                                      ? /* @__PURE__ */ N(
                                          ...
                                          {
                                            className:
                                              "h-px mx-3 bg-black/8 dark:bg-white/10",
                                          },
                                          `sep-${t}`,
                                        )
                                      : /* @__PURE__ */ N(
    ...
    ? /* @__PURE__ */ P("div", {
        children: [
          /* @__PURE__ */ P("button", {
            ...
            className:
              "w-full flex items-center justify-between py-2.5 pr-3 text-[15px] text-left text-black dark:text-white active:bg-black/5 dark:active:bg-white/10 transition-colors",
            children: [
              /* @__PURE__ */ N("span", { children: Xf(e.label, t) }),
              /* @__PURE__ */ N(qd, {
                className: w(
          ...
          /* @__PURE__ */ N(pl, {
            ...
            children:
              ...
              /* @__PURE__ */ N(ld.div, {
                ...
                children: e.children.map((e, o) =>
                  e.separator
                    ? /* @__PURE__ */ N(
                        "div",
                        { className: "h-px mx-3 bg-black/8 dark:bg-white/10" },
                        `sep-${o}`,
                      )
                    : /* @__PURE__ */ N(
                        cp,
    ...
    children:
      ...
      /* @__PURE__ */ P(
        ld.div,
        {
          ...
          className:
            "absolute inset-0 z-[500] bg-white dark:bg-neutral-900 flex flex-col overflow-hidden",
          style: {
            paddingTop: e,
            scale: g,
            y: h,
          ...
          onDragEnd: (e, t) => {
            (t.offset.y < -85 && u.forEach((e) => a(e.id)),
              Bd(h, 0, {
                type: "spring",
                stiffness: 300,
                damping: 30,
          ...
          children: [
              ...
              children:
                ...
                /* @__PURE__ */ P(
                  ld.div,
                  {
                    ...
                    className:
                      "flex items-center gap-2 px-3 border-b border-black/8 dark:border-white/8 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-xl shrink-0 overflow-hidden",
                    children: [
                      /* @__PURE__ */ N("button", {
                        onClick: f,
                        className:
                          "flex items-center gap-0.5 text-blue-500 active:opacity-60 transition-opacity",
                      ...
                      /* @__PURE__ */ N("span", {
                        className:
                          "flex-1 text-center text-[15px] font-semibold text-black dark:text-white truncate",
                        children: p.name,
                      }),
                      p.menuBarMenus && p.menuBarMenus.length > 0
                        ? /* @__PURE__ */ N("button", {
                            onClick: () => l(!0),
                            className:
                              "w-5 h-5 flex items-center justify-center text-blue-500 active:opacity-60 transition-opacity",
            ...
            /* @__PURE__ */ N("div", {
              ...
              children: /* @__PURE__ */ N(lp.Provider, {
                value: s,
            ...
            /* @__PURE__ */ N("div", {
              ...
              className:
                "absolute bottom-0 left-1/2 -translate-x-1/2 w-48 h-10 flex items-center justify-center z-[1000] pointer-events-auto cursor-grab active:cursor-grabbing",
              children: /* @__PURE__ */ N("div", {
                className:
                  "w-32 h-1.5 bg-black/30 dark:bg-white/35 hover:bg-black/50 dark:hover:bg-white/50 rounded-full",
              }),
            }),
          ],
        },
