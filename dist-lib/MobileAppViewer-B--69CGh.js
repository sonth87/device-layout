...
var we = typeof window < "u" ? ve : A, Te = /* @__PURE__ */ fe(null);
//#endregion
...
var Tn = (e, t) => {
	...
	return r.indexes.var.length === i.indexes.var.length && r.indexes.color.length === i.indexes.color.length && r.indexes.number.length >= i.indexes.number.length ? vn.has(e) && !i.values.length || vn.has(t) && !r.values.length ? yn(e, t) : Ie(Sn(wn(r, i), i.values), n) : (ke(!0, `Complex values '${e}' and '${t}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different"), fn(e, t));
};
//#endregion
...
function In({ duration: e = J.duration, bounce: t = J.bounce, velocity: n = J.velocity, mass: r = J.mass }) {
	let i, a;
	ke(e <= /* @__PURE__ */ R(J.maxDuration), "Spring duration must be 10 seconds or less", "spring-duration-limit");
	let o = 1 - t;
	o = F(J.minDamping, J.maxDamping, o), e = F(J.minDuration, J.maxDuration, /* @__PURE__ */ z(e)), o < 1 ? (i = (t) => {
...
function Bn(e) {
	...
	if (!zn(e, Rn) && zn(e, Ln)) if (t.velocity = 0, e.visualDuration) {
		let n = e.visualDuration, r = 2 * Math.PI / (n * 1.2), i = r * r, a = 2 * F(.05, 1, 1 - (e.bounce || 0)) * Math.sqrt(i);
		t = {
			...t,
			mass: J.mass,
			stiffness: i,
...
function Gn(e, t, n) {
	let r = [], i = n || Ae.mix || En, a = e.length - 1;
	for (let n = 0; n < a; n++) {
		let a = i(e[n], e[n + 1]);
...
var nr = class {
	...
	initAnimation() {
		...
		process.env.NODE_ENV !== "production" && s !== Zn && I(o.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${o}`, "spring-two-frames"), s !== Zn && typeof o[0] != "number" && (this.mixKeyframes = Ie(rr, En(o[0], o[1])), o = [0, 100]);
		let c = s({
			...e,
			keyframes: o
		});
	...
	tick(e, t = !1) {
		...
		if (u) {
			...
			!n && e >= 1 && (n = 1), n === 1 && t--, t = Math.min(t, u + 1), t % 2 && (d === "reverse" ? (n = 1 - n, f && (n -= f / o)) : d === "mirror" && (y = a)), v = F(0, 1, n) * o;
		}
		let b;
...
function Vr(e, t) {
	if (e) return typeof e == "function" ? Rr() ? On(e, t) : "ease-out" : ct(e) ? zr(e) : Array.isArray(e) ? e.map((e) => Vr(e, t) || Br.easeOut) : Br[e];
}
//#endregion
...
var Gr = class extends nr {
	...
	attachTimeline({ timeline: e, rangeStart: t, rangeEnd: n, observe: r }) {
		return this.allowFlatten && this.animation.effect?.updateTiming({ easing: "linear" }), this.animation.onfinish = null, e && Lr() ? (this.animation.timeline = e, t && (this.animation.rangeStart = t), n && (this.animation.rangeEnd = n), L) : r(this);
	}
}, Kr = {
	anticipate: $e,
	backInOut: Qe,
...
var Yr = 10, Xr = class extends Gr {
	...
	updateMotionValue(e) {
		...
		let o = new ir({
			...a,
			autoplay: !1
		}), s = Math.max(Yr, H.now() - this.startTime), c = F(0, Yr, s - Yr), l = o.sample(s).value, { name: u } = this.options;
...
function $r(e, t, n, r) {
	...
	return ke(o === s, `You are trying to animate ${t} from "${i}" to "${a}". "${o ? a : i}" is not an animatable value.`, "value-not-animatable"), !o || !s ? !1 : Qr(e) || (n === "spring" || Ur(n)) && r;
}
//#endregion
...
var ii = /* @__PURE__ */ new Set([
	...
	"borderBottomColor",
	"borderLeftColor"
]), ai = /*@__PURE__*/ Pe(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function oi(e) {
...
var si = 40, ci = class extends nr {
	...
	onKeyframesResolved(e, t, n, r) {
		...
		let u = !0;
		$r(e, i, a, o) || (u = !1, (Ae.instantAnimations || !s) && l?.($n(e, n, t)), e[0] = e[e.length - 1], ei(n), n.repeat = 0);
		let d = {
...
var hi = 4;
function gi(e, t, n = 1) {
	I(n <= hi, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`, "max-css-var-depth");
	let [r, i] = mi(e);
	if (!r) return;
...
var Ei = (e, t, n, r = {}, i, a) => (o) => {
	...
	Ti(s) || Object.assign(u, xi(e, u)), u.duration &&= /* @__PURE__ */ R(u.duration), u.repeatDelay &&= /* @__PURE__ */ R(u.repeatDelay), u.from !== void 0 && (u.keyframes[0] = u.from);
	let d = !1;
	if ((u.type === !1 || u.duration === 0 && !u.repeatDelay) && (ei(u), u.delay === 0 && (d = !0)), (Ae.instantAnimations || Ae.skipAnimations || i?.shouldSkipAnimations) && (d = !0, ei(u), u.delay = 0), u.allowFlatten = !s.type && !s.ease, d && !a && t.get() !== void 0) {
...
var Co = class {
	...
	readValue(e, t) {
		...
		return n != null && (typeof n == "string" && (je(n) || Ne(n)) ? n = parseFloat(n) : !no(n) && K.test(t) && (n = da(e, t)), this.setBaseTarget(e, Y(n) ? n.get() : n)), Y(n) ? n.get() : n;
	}
	setBaseTarget(e, t) {
		this.baseTarget[e] = t;
	}
	...
	function s(o) {
		...
		for (let t = 0; t < Ss; t++) {
			...
			for (let e in T) {
				...
				let r = !1;
				r = Ii(t) && Ii(n) ? !bs(t, n) : t !== n, r ? t == null ? u.add(e) : ee(e) : t !== void 0 && u.has(e) ? ee(e) : m.protectedKeys[e] = !0;
			}
...
function Ec({ attachResizeListener: e, defaultParent: t, measureScroll: n, checkIsScrollRoot: r, resetTransform: i }) {
	return class {
		...
		update() {
			...
			let e = H.now();
			V.delta = F(0, 1e3 / 60, e - V.timestamp), V.timestamp = e, V.isProcessing = !0, vt.update.process(V), vt.preRender.process(V), vt.render.process(V), V.isProcessing = !1;
		}
		didUpdate() {
		...
		resolveTargetDelta(e = !1) {
			...
			a && this.linkedParentVersion !== a.layoutVersion && !a.options.layoutRoot && this.removeRelativeTarget(), !this.targetDelta && !this.relativeTarget && (this.options.layoutAnchor !== !1 && a && a.layout ? this.createRelativeTarget(a, this.layout.layoutBox, a.layout.layoutBox) : this.removeRelativeTarget()), !(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = Z(), this.targetWithTransforms = Z()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), Rs(this.target, this.relativeTarget, this.relativeParent.target, this.options.layoutAnchor || void 0)) : this.targetDelta ? (this.resumingFrom ? this.applyTransform(this.layout.layoutBox, !1, this.target) : Q(this.target, this.layout.layoutBox), Lo(this.target, this.targetDelta)) : Q(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget && (this.attemptToResolveRelativeTarget = !1, this.options.layoutAnchor !== !1 && a && !!a.resumingFrom == !!this.resumingFrom && !a.options.layoutScroll && a.target && this.animationProgress !== 1 ? this.createRelativeTarget(a, this.target, a.target) : this.relativeParent = this.relativeTarget = void 0), pt.value && bc.calculatedTargetDeltas++);
		}
...
var au = (e, t) => t.isSVG ?? Bl(e) ? new _s(t) : new as(t, { allowProjection: e !== ue }), ou = class extends To {
	constructor(e) {
...
function Ou(e, t) {
	let n = .5, r = $(e), i = $(t);
	return i > r ? n = /* @__PURE__ */ Le(t.min, t.max - r, e.min) : r > i && (n = /* @__PURE__ */ Le(e.min, e.max - i, t.min)), F(0, 1, n);
}
function ku(e, t) {
	let n = {};
...
function Gd() {
	let e = C((e) => e.osTheme), t = C((e) => e.resolvedColorScheme), n = C((e) => e.glassEnabled), r = Wd[e];
	return {
		osTheme: e,
		colorScheme: t,
		glassEnabled: n,
...
var Kd = T("battery", [["path", {
	...
	rx: "2",
	key: "13zb55"
}]]), qd = T("chevron-down", [["path", {
	d: "m6 9 6 6 6-6",
	key: "qrunsl"
}]]), Jd = T("loader-circle", [["path", {
...
var nf = "Popover", [rf, af] = o(nf, [b]), of = b(), [sf, cf] = rf(nf), lf = (e) => {
	let { __scopePopover: t, children: n, open: r, defaultOpen: i, onOpenChange: a, modal: o = !1 } = e, s = of(t), l = E.useRef(null), [u, d] = E.useState(!1), [p, m] = _({
		prop: r,
		defaultProp: i ?? !1,
		onChange: a,
		caller: nf
...
lf.displayName = nf;
var uf = "PopoverAnchor", df = E.forwardRef((e, t) => {
	let { __scopePopover: n, ...r } = e, i = cf(uf, n), a = of(n), { onCustomAnchorAdd: o, onCustomAnchorRemove: s } = i;
	return E.useEffect(() => (o(), () => s()), [o, s]), /* @__PURE__ */ N(h, {
		...a,
		...r,
		ref: t
	});
...
df.displayName = uf;
var ff = "PopoverTrigger", pf = E.forwardRef((t, n) => {
	let { __scopePopover: i, ...a } = t, o = cf(ff, i), s = of(i), c = r(n, o.triggerRef), l = /* @__PURE__ */ N(u.button, {
		type: "button",
...
pf.displayName = ff;
var mf = "PopoverPortal", [hf, gf] = rf(mf, { forceMount: void 0 }), _f = (e) => {
	let { __scopePopover: t, forceMount: n, children: r, container: i } = e, o = cf(mf, t);
...
_f.displayName = mf;
var vf = "PopoverContent", yf = E.forwardRef((e, t) => {
	let n = gf(vf, e.__scopePopover), { forceMount: r = n.forceMount, ...i } = e, a = cf(vf, e.__scopePopover);
	return /* @__PURE__ */ N(d, {
		present: r || a.open,
		children: a.modal ? /* @__PURE__ */ N(xf, {
			...i,
			ref: t
		}) : /* @__PURE__ */ N(Sf, {
			...i,
...
yf.displayName = vf;
var bf = x("PopoverContent.RemoveScroll"), xf = E.forwardRef((t, n) => {
	let i = cf(vf, t.__scopePopover), a = E.useRef(null), o = r(n, a), s = E.useRef(!1);
	return E.useEffect(() => {
		let e = a.current;
		if (e) return m(e);
	}, []), /* @__PURE__ */ N(y, {
	...
	let n = cf(vf, e.__scopePopover), r = E.useRef(!1), i = E.useRef(!1);
	...
	let { __scopePopover: n, trapFocus: r, onOpenAutoFocus: i, onCloseAutoFocus: a, disableOutsidePointerEvents: o, onEscapeKeyDown: c, onPointerDownOutside: u, onFocusOutside: d, onInteractOutside: f, ...m } = e, h = cf(vf, n), _ = of(n);
...
}), wf = "PopoverClose", Tf = E.forwardRef((t, n) => {
	let { __scopePopover: r, ...i } = t, a = cf(wf, r);
...
Tf.displayName = wf;
var Ef = "PopoverArrow", Df = E.forwardRef((e, t) => {
...
function If(e, t, n) {
	let r = Ff(e, e.VERTEX_SHADER, t), i = Ff(e, e.FRAGMENT_SHADER, n);
	if (!r || !i) return null;
...
function Hf({ children: e, className: t, variant: n = "panel", forceGlass: r, borderRadius: i, style: a, ref: o, ...s }) {
	let { isGlass: c, colorScheme: l } = Gd(), u = r === void 0 ? c : r, d = C((e) => e.glassMode), f = i ?? Bf[n], p = f ? { borderRadius: f } : {}, m = Vf[n], { elementRef: h, maps: g } = zf(), _ = E.useCallback((e) => {
	...
	return u ? d === "clear" ? /* @__PURE__ */ P("div", {
		...
		children: [
			...
			u && /* @__PURE__ */ N(Rf, { className: "absolute inset-0 w-full h-full z-30 opacity-25 pointer-events-none" }),
			u && g && /* @__PURE__ */ N("svg", {
				"aria-hidden": !0,
				style: {
					position: "absolute",
...
function Uf() {
	...
	return /* @__PURE__ */ P(kf, {
		...
		}), /* @__PURE__ */ N(jf, { children: /* @__PURE__ */ N(Mf, {
			align: "end",
			sideOffset: 6,
...
var Wf = fe("dark");
function Gf() {
	return k(Wf) === "light" ? "text-black/80 hover:bg-black/10" : "text-white/85 hover:bg-white/10";
}
var Kf = "flex h-6 items-center rounded-md px-2.5 text-[13px] leading-none transition-colors";
...
function Zf({ item: e, t, onSelect: n }) {
	...
	return A(() => () => {
		...
		children: [/* @__PURE__ */ P("button", {
			...
			children: [/* @__PURE__ */ N("span", { children: Xf(e.label, t) }), /* @__PURE__ */ N(ee, { className: "w-3.5 h-3.5 ml-6 opacity-60" })]
			...
			children: /* @__PURE__ */ N(Hf, {
				...
				children: e.children.map((e, r) => e.separator ? /* @__PURE__ */ N(Jf, {}, `sep-${r}`) : /* @__PURE__ */ N(Zf, {
					item: e,
					t,
					onSelect: n
				}, e.key))
...
function ep({ activeId: e, setActiveId: t }) {
	...
	}, [n, t]), i = Gf(), [a, o] = M(!1), s = j(null), c = C((e) => e.apps), l = C((e) => e.launchApp), { t: u } = oe(), d = O(() => r(!1), [r]);
...
function tp({ appConfig: e, appId: t, activeId: n, setActiveId: r }) {
	...
	}, [i, r]), o = Gf(), s = j(null), c = C((e) => e.closeWindow), { t: l, getAppName: u } = oe(), d = e ? u(e.id, e.name) : l.appNameFinder, f = O(() => a(!1), [a]), p = (e) => {
	...
	return /* @__PURE__ */ P(be, { children: [/* @__PURE__ */ N("button", {
		...
		className: w(Kf, "font-semibold", i ? "bg-accent-active text-white" : o),
		children: /* @__PURE__ */ N("span", {
...
function np({ label: e, items: t, appId: n, windowId: r, activeId: i, setActiveId: a }) {
	let o = i === e, s = O((t) => {
		...
		e,
		a
	]), c = Gf(), l = j(null), { t: u } = oe(), d = O(() => s(!1), [s]), f = (e) => {
	...
	return /* @__PURE__ */ P(be, { children: [/* @__PURE__ */ N("button", {
		...
		onClose: d,
		minWidth: 192,
		children: t.map((e, t) => e.separator ? /* @__PURE__ */ N(Jf, {}, `sep-${t}`) : /* @__PURE__ */ N(Zf, {
			item: e,
			t: u,
			onSelect: f
		}, e.key))
...
var ip = {
	Finder: D(() => import("./Finder-gAzk-qeN.js").then((e) => ({ default: e.Finder }))),
	Terminal: D(() => import("./Terminal-BFIScMKe.js").then((e) => ({ default: e.Terminal }))),
	Settings: D(() => import("./Settings-EKaEB-c0.js").then((e) => ({ default: e.Settings }))),
	Browser: D(() => import("./Browser-DgZHqpHg.js").then((e) => ({ default: e.Browser }))),
	TextEditor: D(() => import("./TextEditor-DvB3D_bZ.js").then((e) => ({ default: e.TextEditor }))),
	Clock: D(() => import("./Clock-0pbhFf7x.js").then((e) => ({ default: e.Clock }))),
	Notes: D(() => import("./Notes-gy8L9RJK.js").then((e) => ({ default: e.Notes }))),
	Photos: D(() => import("./Photos-BsOMZ1K_.js").then((e) => ({ default: e.Photos }))),
	Music: D(() => import("./Music-B_4gUAv9.js").then((e) => ({ default: e.Music }))),
	Calendar: D(() => import("./Calendar-DZK0kYfd.js").then((e) => ({ default: e.Calendar }))),
	Messages: D(() => import("./Messages-C9NTv7c4.js").then((e) => ({ default: e.Messages }))),
	IframeApp: D(() => import("./IframeApp-CiFT-Yhs.js").then((e) => ({ default: e.IframeApp }))),
	MdxApp: D(() => import("./MdxApp-kzj2xGeR.js").then((e) => ({ default: e.MdxApp })))
};
function ap() {
...
function op({ appId: e, windowId: t }) {
	...
	if (n.render) {
		...
		return /* @__PURE__ */ N(de, {
			...
			children: /* @__PURE__ */ N(se, { children: /* @__PURE__ */ N(r, {
				appId: e,
				windowId: t
			}) })
		});
		...
		children: [/* @__PURE__ */ N("div", {
			...
			children: e.map((e) => /* @__PURE__ */ P("div", {
				...
				children: [/* @__PURE__ */ N("div", {
					...
					children: e.items.map((e, t) => e.separator ? /* @__PURE__ */ N("div", { className: "h-px mx-3 bg-black/8 dark:bg-white/10" }, `sep-${t}`) : /* @__PURE__ */ N(cp, {
						item: e,
						t: i,
						onSelect: s,
						expandedKey: a,
...
function cp({ item: e, t, onSelect: n, expandedKey: r, setExpandedKey: i, depth: a = 0 }) {
	...
	return o ? /* @__PURE__ */ P("div", { children: [/* @__PURE__ */ P("button", {
		...
		children: [/* @__PURE__ */ N("span", { children: Xf(e.label, t) }), /* @__PURE__ */ N(qd, { className: w("w-4 h-4 opacity-50 transition-transform", s && "rotate-180") })]
	}), /* @__PURE__ */ N(pl, {
		initial: !1,
		children: s && /* @__PURE__ */ N(ld.div, {
			...
			children: e.children.map((e, o) => e.separator ? /* @__PURE__ */ N("div", { className: "h-px mx-3 bg-black/8 dark:bg-white/10" }, `sep-${o}`) : /* @__PURE__ */ N(cp, {
				item: e,
				t,
				onSelect: n,
				expandedKey: r,
		...
		children: [/* @__PURE__ */ N("span", { children: Xf(e.label, t) }), e.shortcut && /* @__PURE__ */ N("span", {
...
function dp({ statusBarHeight: e, navBarHeight: t, homeIndicatorHeight: n = 20 }) {
	let r = C((e) => e.windows), i = C((e) => e.apps), a = C((e) => e.closeWindow), [o, s] = M(!1), [c, l] = M(!1), u = Object.values(r).filter((e) => !e.isMinimized).sort((e, t) => t.zIndex - e.zIndex), d = u[0] ?? null, f = O(() => {
		d && a(d.id);
	...
	return /* @__PURE__ */ N(pl, { children: d && p && /* @__PURE__ */ P(ld.div, {
		...
		children: [
			...
			p.menuBarMenus && p.menuBarMenus.length > 0 && /* @__PURE__ */ N(sp, {
...
//#endregion
export { Y as C, nl as S, B as T, Bd as _, np as a, ld as b, ef as c, Zd as d, Xd as f, Wd as g, Gd as h, rp as i, $d as l, Kd as m, up as n, Hf as o, qd as p, op as r, tf as s, dp as t, Qd as u, pd as v, ir as w, pl as x, ud as y };
