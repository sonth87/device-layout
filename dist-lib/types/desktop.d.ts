export type StackGroupBy = 'kind' | 'shared-by' | 'date-last-opened' | 'date-added' | 'date-modified' | 'date-created' | 'tags';
...
export type WallpaperCycleInterval = '5m' | '10m' | '30m' | '1h' | '2h' | '5h' | '1d';
