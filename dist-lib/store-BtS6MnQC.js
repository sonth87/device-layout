import e from "react";
//#region ../sky-app/node_modules/.pnpm/zustand@5.0.14_@types+react@19.2.17_immer@11.1.15_react@19.2.8_use-sync-external-store@1.6.0_react@19.2.8_/node_modules/zustand/esm/vanilla.mjs
var t = (e) => {
...
function d(e, ...t) {
	if (process.env.NODE_ENV !== "production") {
		let n = u[e], r = j(n) ? n.apply(null, t) : n;
		throw Error(`[Immer] ${r}`);
	}
...
function x(e) {
	return e ? ne(e) || D(e) || !!e[c] || !!e[m]?.[c] || O(e) || k(e) : !1;
}
...
function C(e) {
	let t = e[l];
	return t ? t.type_ : D(e) ? 1 : O(e) ? 2 : k(e) ? 3 : 0;
}
var w = (e, t, n = C(e)) => n === 2 ? e.has(t) : f[h].hasOwnProperty.call(e, t), T = (e, t, n = C(e)) => n === 2 ? e.get(t) : e[t], E = (e, t, n, r = C(e)) => {
	r === 2 ? e.set(t, n) : r === 3 ? e.add(n) : e[t] = n;
};
function re(e, t) {
	return e === t ? e !== 0 || 1 / e == 1 / t : e !== e && t !== t;
}
var D = Array.isArray, O = (e) => e instanceof Map, k = (e) => e instanceof Set, A = (e) => typeof e == "object", j = (e) => typeof e == "function", M = (e) => typeof e == "boolean";
function ie(e) {
	let t = +e;
	return Number.isInteger(t) && String(t) === e;
}
var N = (e) => e.copy_ || e.base_, P = (e) => e.modified_ ? e.copy_ : e.base_;
function ae(e, t) {
	if (O(e)) return new Map(e);
	if (k(e)) return new Set(e);
	if (D(e)) return Array[h].slice.call(e);
	let n = ne(e);
...
function F(e, t = !1) {
	return L(e) || b(e) || !x(e) ? e : (C(e) > 1 && f.defineProperties(e, {
		set: I,
		add: I,
		clear: I,
		delete: I
...
var I = { [y]: oe };
function L(e) {
	return e === null || !A(e) || f.isFrozen(e);
}
var R = "MapSet", z = "Patches", se = "ArrayMethods", ce = {};
function B(e) {
	let t = ce[e];
	return t || d(0, e), t;
}
var le = (e) => !!ce[e], V, ue = () => V, de = (e, t) => ({
	drafts_: [],
	parent_: e,
	immer_: t,
	canAutoFreeze_: !0,
	...
	mapSetPlugin_: le(R) ? B(R) : void 0,
	arrayMethodsPlugin_: le(se) ? B(se) : void 0
});
function fe(e, t) {
	t && (e.patchPlugin_ = B(z), e.patches_ = [], e.inversePatches_ = [], e.patchListener_ = t);
}
function H(e) {
	U(e), e.drafts_.forEach(me), e.drafts_ = null;
}
function U(e) {
	e === V && (V = e.parent_);
}
...
function he(e, t) {
	...
	let n = t.drafts_[0];
	if (e !== void 0 && e !== n) {
		n[l].modified_ && (H(t), d(4)), x(e) && (e = ge(t, e));
		let { patchPlugin_: r } = t;
		r && r.generateReplacementPatches_(n[l].base_, e, t);
	} else e = ge(t, n);
	return _e(t, e, !0), H(t), t.patches_ && t.patchListener_(t.patches_, t.inversePatches_), e === s ? void 0 : e;
}
function ge(e, t) {
	if (L(t)) return t;
	let n = t[l];
	if (!n) return G(t, e.handledSet_, e);
	if (!W(n, e)) return t;
...
var W = (e, t) => e.scope_ === t, ye = [];
function be(e, t, n, r) {
	let i = N(e), a = e.type_;
	if (r !== void 0 && T(i, r, a) === t) {
		E(i, r, n, a);
		return;
	}
	...
	let o = e.draftLocations_.get(t) ?? ye;
	for (let e of o) E(i, e, n, a);
}
function xe(e, t, n) {
...
function Ce(e, t, n) {
	...
	if (b(n)) {
		let i = n[l];
		W(i, r) && i.callbacks_.push(function() {
			X(e), be(e, n, P(i), t);
		});
	} else x(n) && e.callbacks_.push(function() {
		let i = N(e);
		e.type_ === 3 ? i.has(n) && G(n, r.handledSet_, r) : T(i, t, e.type_) === n && r.drafts_.length > 1 && (e.assigned_.get(t) ?? !1) === !0 && e.copy_ && G(T(e.copy_, t, e.type_), r.handledSet_, r);
	});
}
function G(e, t, n) {
	return !n.immer_.autoFreeze_ && n.unfinalizedDrafts_ < 1 || b(e) || t.has(e) || !x(e) || L(e) ? e : (t.add(e), S(e, (r, i) => {
		if (b(i)) {
			let t = i[l];
			W(t, n) && (E(e, r, P(t), e.type_), ve(t));
		} else x(i) && G(i, t, n);
	}), e);
}
function we(e, t) {
...
var K = {
	get(e, t) {
		...
		let i = N(e);
		if (!w(i, t, e.type_)) return Ee(e, i, t);
		let a = i[t];
		if (e.finalized_ || !x(a) || r && e.operationMethod && n?.isMutatingArrayMethod(e.operationMethod) && ie(t)) return a;
		if (a === J(e.base_, t) || Te(e, t, a)) {
			X(e);
			let n = e.type_ === 1 ? +t : t, r = Z(e.scope_, a, e, n);
			return e.copy_[n] = r;
		}
		return a;
	},
	...
	set(e, t, n) {
		...
		if (!e.modified_) {
			...
			if (re(n, r) && (n !== void 0 || w(e.base_, t, e.type_))) return !0;
			X(e), Y(e);
		}
		return e.copy_[t] === n && (n !== void 0 || w(e.copy_, t, e.type_)) || Number.isNaN(n) && Number.isNaN(e.copy_[t]) ? !0 : (e.copy_[t] = n, e.assigned_.set(t, !0), Ce(e, t, n), !0);
	},
	deleteProperty(e, t) {
		return X(e), J(e.base_, t) !== void 0 || t in e.base_ ? (e.assigned_.set(t, !1), Y(e)) : e.assigned_.delete(t), e.copy_ && delete e.copy_[t], !0;
	},
	getOwnPropertyDescriptor(e, t) {
		let n = N(e), r = Reflect.getOwnPropertyDescriptor(n, t);
		return r && {
			[v]: !0,
...
q.deleteProperty = function(e, t) {
	...
	return process.env.NODE_ENV !== "production" && t !== "length" && isNaN(parseInt(t)) && d(14), K.set.call(this, e[0], t, n, e[0]);
};
function J(e, t) {
	let n = e[l];
	return (n ? N(n) : e)[t];
...
function Te(e, t, n) {
	return e.type_ !== 1 || !e.allIndicesReassigned_ || e.assigned_?.get(t) || !x(n) || n[l] ? !1 : e.baseRefs_.has(n);
}
function Ee(e, t, n) {
	let r = De(t, n);
...
function X(e) {
	e.copy_ ||= (e.assigned_ = /* @__PURE__ */ new Map(), ae(e.base_, e.scope_.immer_.useStrictShallowCopy_));
}
var Oe = class {
	constructor(e) {
		this.autoFreeze_ = !0, this.useStrictShallowCopy_ = !1, this.useStrictIteration_ = !1, this.produce = (e, t, n) => {
			...
			j(t) || d(6), n !== void 0 && !j(n) && d(7);
			let r;
			if (x(e)) {
				let i = pe(this), a = Z(i, e, void 0), o = !0;
				try {
					r = t(a), o = !1;
				} finally {
					o ? H(i) : U(i);
				}
				return fe(i, n), he(r, i);
			} else if (!e || !A(e)) {
				if (r = t(e), r === void 0 && (r = e), r === s && (r = void 0), this.autoFreeze_ && F(r, !0), n) {
					let t = [], i = [];
					B(z).generateReplacementPatches_(e, r, {
						patches_: t,
						inversePatches_: i
					}), n(t, i);
				}
		...
		}, M(e?.autoFreeze) && this.setAutoFreeze(e.autoFreeze), M(e?.useStrictShallowCopy) && this.setUseStrictShallowCopy(e.useStrictShallowCopy), M(e?.useStrictIteration) && this.setUseStrictIteration(e.useStrictIteration);
	}
	createDraft(e) {
		x(e) || d(8), b(e) && (e = ke(e));
		let t = pe(this), n = Z(t, e, void 0);
		return n[l].isManual_ = !0, U(t), n;
	}
	finishDraft(e, t) {
		let n = e && e[l];
		(!n || !n.isManual_) && d(9);
		let { scope_: r } = n;
		return fe(r, t), he(void 0, r);
	}
	setAutoFreeze(e) {
		this.autoFreeze_ = e;
	}
	...
	applyPatches(e, t) {
		...
		n > -1 && (t = t.slice(n + 1));
		let r = B(z).applyPatches_;
		return b(e) ? r(e, t) : this.produce(e, (e) => r(e, t));
	}
};
function Z(e, t, n, r) {
	let [i, a] = O(t) ? B(R).proxyMap_(t, n) : k(t) ? B(R).proxySet_(t, n) : we(t, n);
	return (n?.scope_ ?? ue()).drafts_.push(i), a.callbacks_ = n?.callbacks_ ?? [], a.key_ = r, n && r !== void 0 ? xe(n, a, r) : a.callbacks_.push(function(e) {
...
function Ae(e) {
	...
	if (t) {
		...
		t.finalized_ = !0, n = ae(e, t.scope_.immer_.useStrictShallowCopy_), r = t.scope_.immer_.shouldUseStrictIteration();
	} else n = ae(e, !0);
	return S(n, (e, t) => {
		E(n, e, Ae(t));
...
//#endregion
//#region ../sky-app/node_modules/.pnpm/zustand@5.0.14_@types+react@19.2.17_immer@11.1.15_react@19.2.8_use-sync-external-store@1.6.0_react@19.2.8_/node_modules/zustand/esm/middleware.mjs
function Ne(e, t) {
	let n;
	try {
		n = e();
...
var Pe = (e) => (t) => {
	...
	let m, h = () => {
		...
		return Pe(u.getItem.bind(u))(a.name).then((e) => {
...
function Re(e, t, { minWidth: n = 320, minHeight: r = 240 } = {}) {
...
function ze(e, t, n, r, i = 320, a = 240) {
...
function et(e) {
	return {
		...
		removeCustomWallpaper(t) {
			e((e) => {
				e.customWallpapers = e.customWallpapers.filter((e) => e.id !== t), e.wallpaperId === t && (e.wallpaperId = $e);
			});
		},
		setWallpaperCycle(t) {
			e((e) => {
		...
		pushNotification(t) {
			...
			return e((e) => {
				e.notifications.unshift({
					...
					timestamp: Date.now(),
					read: !1
				}), e.notifications.length > tt && (e.notifications = e.notifications.slice(0, tt));
			}), n;
		},
		markRead(t) {
			e((e) => {
...
function ot(e, t) {
	return {
		...
		vfsLs(e) {
			...
			return Object.values(n).filter((e) => e.path !== r && rt(e.path) === r);
		},
		vfsExists(e) {
			return !!t().vfs[e];
		}
...
//#endregion
export { Ye as a, Ue as c, Re as d, o as f, Xe as i, Be as l, Qe as n, Ze as o, $e as r, We as s, ct as t, ze as u };
