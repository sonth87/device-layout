...
import { t as S } from "./store-BQ3wWDKN.js";
...
import { Fragment as Se, jsx as j, jsxs as M } from "react/jsx-runtime";
...
var F = /* @__NO_SIDE_EFFECTS__ */ (e) => e, Le = (e, t) => (n) => t(e(n)), Re = (...e) => e.reduce(Le), ze = /* @__NO_SIDE_EFFECTS__ */ (e, t, n) => {
	let r = t - e;
	return r === 0 ? 1 : (n - e) / r;
}, Be = class {
	constructor() {
...
var ut = (e) => Array.isArray(e) && typeof e[0] == "number", dt = {
	...
	if (ut(e)) {
		...
		let [t, n, r, i] = e;
		return Ye(t, n, r, i);
	} else if (ft(e)) return P(dt[e] !== void 0, `Invalid easing type '${e}'`, "invalid-easing-type"), dt[e];
	return e;
}, mt = [
	"setup",
	"read",
...
function ht(e, t) {
	...
	let u = {
		...
		process: (e) => {
			...
			i = !0;
			let o = n;
			n = r, r = o, n.forEach(l), t && R.value && R.value.frameloop[t].push(c), c = 0, n.clear(), i = !1, a && (a = !1, u.process(e));
		}
	};
	return u;
}
...
var { schedule: z, cancel: vt, state: B, steps: yt } = /* @__PURE__ */ _t(typeof requestAnimationFrame < "u" ? requestAnimationFrame : F, !0), bt;
function xt() {
	bt = void 0;
}
var V = {
	now: () => (bt === void 0 && V.set(B.isProcessing || Me.useManualTiming ? B.timestamp : performance.now()), bt),
	set: (e) => {
...
var Ht = {
	...
	parse: parseFloat,
	transform: (t) => `${t}${e}`
}), Wt = /*@__PURE__*/ Ut("deg"), H = /*@__PURE__*/ Ut("%"), U = /*@__PURE__*/ Ut("px"), Gt = /*@__PURE__*/ Ut("vh"), Kt = /*@__PURE__*/ Ut("vw"), qt = {
	...H,
	...
	transform: ({ hue: e, saturation: t, lightness: n, alpha: r = 1 }) => "hsla(" + Math.round(e) + ", " + H.transform(Mt(t)) + ", " + H.transform(Mt(n)) + ", " + Mt(At.transform(r)) + ")"
}, W = {
...
function on({ split: e, types: t }) {
	...
	return (r) => {
		...
		for (let a = 0; a < n; a++) if (i += e[a], r[a] !== void 0) {
			let e = t[a];
			e === Zt ? i += Mt(r[a]) : e === Qt ? i += W.transform(r[a]) : i += r[a];
		}
		return i;
	};
}
...
var vn = (e, t) => {
	...
	let i = { ...n };
	return (e) => (i.red = mn(n.red, r.red, e), i.green = mn(n.green, r.green, e), i.blue = mn(n.blue, r.blue, e), i.alpha = K(n.alpha, r.alpha, e), Bt.transform(i));
...
function Sn(e) {
	return typeof e == "number" ? xn : typeof e == "string" ? Et(e) ? pn : W.test(e) ? vn : En : Array.isArray(e) ? Cn : typeof e == "object" ? W.test(e) ? vn : wn : pn;
}
function Cn(e, t) {
...
function Ln({ duration: e = q.duration, bounce: t = q.bounce, velocity: n = q.velocity, mass: r = q.mass }) {
	let i, a;
	je(e <= /* @__PURE__ */ I(q.maxDuration), "Spring duration must be 10 seconds or less", "spring-duration-limit");
	let o = 1 - t;
	o = N(q.minDamping, q.maxDamping, o), e = N(q.minDuration, q.maxDuration, /* @__PURE__ */ L(e)), o < 1 ? (i = (t) => {
...
function Hn(e = q.visualDuration, t = q.bounce) {
	...
	let ee = {
		...
		next: (e) => {
			if (!p && h < 1) {
				let t = Math.exp(-h * _ * e), n = Math.sin(x * e), a = Math.cos(x * e), c = o - t * (S * n + g * a), l = /* @__PURE__ */ I(t * (C * n + w * a));
		...
		toString: () => {
			let e = Math.min(jn(ee), An), t = kn((t) => ee.next(e * t).value, e, 30);
			return e + "ms " + t;
		},
		toTransition: () => {}
	};
...
function Kn(e, t, n) {
	...
	for (let n = 0; n < a; n++) {
		let a = i(e[n], e[n + 1]);
		t && (a = Re(Array.isArray(t) ? t[n] || F : t, a)), r.push(a);
	}
	return r;
}
...
var rr = class {
	...
	constructor(e) {
		super(), this.state = "idle", this.startTime = null, this.isStopped = !1, this.currentTime = 0, this.holdTime = null, this.playbackSpeed = 1, this.delayState = {
			...
			e && e.updatedAt !== V.now() && this.tick(V.now()), this.isStopped = !0, this.state !== "idle" && (this.teardown(), this.options.onStop?.());
	...
	initAnimation() {
		...
		process.env.NODE_ENV !== "production" && s !== Qn && P(o.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${o}`, "spring-two-frames"), s !== Qn && typeof o[0] != "number" && (this.mixKeyframes = Re(ir, Dn(o[0], o[1])), o = [0, 100]);
		let c = s({
			...e,
			keyframes: o
		});
	...
	set speed(e) {
		...
		t && this.driver && this.updateTime(V.now()), this.playbackSpeed = e, t && this.driver && (this.time = /* @__PURE__ */ L(this.currentTime));
	}
	play() {
...
var yr = [
	...
	"skewX",
	"skewY"
], br = /* @__PURE__ */ new Set(yr), xr = (e) => e === kt || e === U, Sr = /* @__PURE__ */ new Set([
	"x",
	"y",
	"z"
...
var Nr = class {
	...
	scheduleResolve() {
		this.state = "scheduled", this.isAsync ? (Er.add(this), Dr || (Dr = !0, z.read(jr), z.resolveKeyframes(Ar))) : (this.readKeyframes(), this.complete());
	}
	readKeyframes() {
...
function Ur(e, t, n, { delay: r = 0, duration: i = 300, repeat: a = 0, repeatType: o = "loop", ease: s = "easeOut", times: c } = {}, l = void 0) {
	...
	c && (u.offset = c);
	let d = Hr(s, i);
	Array.isArray(d) && (u.easing = d), R.value && St.waapi++;
	let f = {
		delay: r,
		duration: i,
	...
	l && (f.pseudoElement = l);
	let p = e.animate(u, f);
	return R.value && p.finished.finally(() => {
		St.waapi--;
	}), p;
}
//#endregion
...
var Kr = class extends rr {
	...
	attachTimeline({ timeline: e, rangeStart: t, rangeEnd: n, observe: r }) {
		return this.allowFlatten && this.animation.effect?.updateTiming({ easing: "linear" }), this.animation.onfinish = null, e && Rr() ? (this.animation.timeline = e, t && (this.animation.rangeStart = t), n && (this.animation.rangeEnd = n), F) : r(this);
	}
}, qr = {
	anticipate: tt,
	backInOut: et,
...
var Xr = 10, Zr = class extends Kr {
	...
	updateMotionValue(e) {
		...
		let o = new ar({
			...a,
			autoplay: !1
		}), s = Math.max(Xr, V.now() - this.startTime), c = N(0, Xr, s - Xr), l = o.sample(s).value, { name: u } = this.options;
...
var gi = 4;
function _i(e, t, n = 1) {
	P(n <= gi, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`, "max-css-var-depth");
	let [r, i] = hi(e);
	if (!r) return;
...
var Di = (e, t, n, r = {}, i, a) => (o) => {
	...
	Ei(s) || Object.assign(u, Si(e, u)), u.duration &&= /* @__PURE__ */ I(u.duration), u.repeatDelay &&= /* @__PURE__ */ I(u.repeatDelay), u.from !== void 0 && (u.keyframes[0] = u.from);
	let d = !1;
...
var ji = /* @__PURE__ */ new Set([
	...
	setCurrent(e) {
		this.current = e, this.updatedAt = V.now(), this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = Ni(this.current));
	}
...
var { schedule: ya, cancel: ba } = /* @__PURE__ */ _t(queueMicrotask, !1), Y = {
	x: !1,
	y: !1
};
function xa() {
...
var wo = class {
	...
	readValue(e, t) {
		...
		return n != null && (typeof n == "string" && (Ne(n) || Fe(n)) ? n = parseFloat(n) : !ro(n) && G.test(t) && (n = fa(e, t)), this.setBaseTarget(e, J(n) ? n.get() : n)), J(n) ? n.get() : n;
	}
	setBaseTarget(e, t) {
		this.baseTarget[e] = t;
	}
...
function Vo(e, t, n, r = !1) {
	...
	for (let s = 0; s < i; s++) {
		...
		i && i.props.style && i.props.style.display === "contents" || (r && a.options.layoutScroll && a.scroll && a !== a.root && (Z(e.x, -a.scroll.offset.x), Z(e.y, -a.scroll.offset.y)), o && (t.x *= o.x.scale, t.y *= o.y.scale, Ro(e, o)), r && Mo(a.latestValues) && Wo(e, a.latestValues, a.layout?.layoutBox));
	}
...
function Ko(e, t, n) {
	...
	return i && (Z(r.x, i.offset.x), Z(r.y, i.offset.y)), r;
}
//#endregion
...
function ns(e, { layout: t, layoutId: n }) {
	return br.has(e) || e.startsWith("origin") || (t || n !== void 0) && (!!ts[e] || e === "opacity");
}
//#endregion
...
function rs(e, t, n) {
	...
	if (!r) return a;
	for (let t in r) (J(r[t]) || i && J(i[t]) || ns(t, e) || n?.getValue(t)?.liveStyle !== void 0) && (a[t] = r[t]);
	return a;
}
//#endregion
...
var as = class extends To {
	...
	readValueFromInstance(e, t) {
		...
		{
			let n = is(e), r = (wt(t) ? n.getPropertyValue(t) : n[t]) || 0;
...
function hs(e, t, n, r) {
	Zo(e, t, void 0, r);
	for (let n in t.attrs) e.setAttribute(ps.has(n) ? n : Ui(n), t.attrs[n]);
}
//#endregion
...
var _s = class extends To {
	...
	readValueFromInstance(e, t) {
		...
		return t = ps.has(t) ? t : Ui(t), e.getAttribute(t);
	}
	scrapeMotionValuesFromProps(e, t, n) {
		return gs(e, t, n);
	}
...
var xs = [...uo].reverse(), Ss = uo.length;
function Cs(e) {
...
function ws(e) {
	...
	function s(o) {
		...
		for (let t = 0; t < Ss; t++) {
			let p = xs[t], m = n[p], h = s[p] === void 0 ? c[p] : s[p], g = lo(h), _ = p === o ? m.isActive : null;
			_ === !1 && (f = t);
			let v = h === c[p] && h !== s[p] && g;
			...
			for (let e in ee) {
				...
				let r = !1;
				r = Li(t) && Li(n) ? !bs(t, n) : t !== n, r ? t == null ? u.add(e) : te(e) : t !== void 0 && u.has(e) ? te(e) : m.protectedKeys[e] = !0;
			}
...
function Fs(e, t, n, r = .5) {
	e.origin = r, e.originPoint = K(t.min, t.max, e.origin), e.scale = $(n) / $(t), e.translate = K(n.min, n.max, e.origin) - e.originPoint, (e.scale >= As && e.scale <= js || isNaN(e.scale)) && (e.scale = 1), (e.translate >= Ms && e.translate <= Ns || isNaN(e.translate)) && (e.translate = 0);
}
function Is(e, t, n, r) {
	Fs(e.x, t.x, n.x, r ? r.originX : void 0), Fs(e.y, t.y, n.y, r ? r.originY : void 0);
}
function Ls(e, t, n, r = 0) {
	e.min = (r ? K(n.min, n.max, r) : n.min) + t.min, e.max = e.min + $(t);
}
function Rs(e, t, n, r) {
...
function Hs(e, t = 0, n = 1, r = .5, i, a = e, o = e) {
	if (H.test(t) && (t = parseFloat(t), t = K(o.min, o.max, t / 100) - o.min), typeof t != "number") return;
...
function sc(e, t, n, r, i, a) {
	...
	for (let i = 0; i < ic; i++) {
		...
		o === void 0 && s === void 0 || (o ||= 0, s ||= 0, o === 0 || s === 0 || oc(o) === oc(s) ? (e[a] = Math.max(K(ac(o), ac(s), r), 0), (H.test(s) || H.test(o)) && (e[a] += "%")) : e[a] = s);
	}
...
var lc = /*@__PURE__*/ dc(0, .5, rt), uc = /*@__PURE__*/ dc(.5, .95, F);
function dc(e, t, n) {
...
function gc(e, t) {
	let n = V.now(), r = ({ timestamp: i }) => {
		let a = i - n;
		a >= t && (vt(r), e(a - t));
	};
	return z.setup(r, !0), () => vt(r);
}
//#endregion
	...
	return class {
		constructor(e = {}, n = t?.()) {
			this.id = Cc++, this.animationId = 0, this.animationCommitId = 0, this.children = /* @__PURE__ */ new Set(), this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
				...
				this.projectionUpdateScheduled = !1, R.value && (bc.nodes = bc.calculatedTargetDeltas = bc.calculatedProjections = 0), this.nodes.forEach(kc), this.nodes.forEach(Rc), this.nodes.forEach(zc), this.nodes.forEach(Ac), R.addProjectionMetrics && R.addProjectionMetrics(bc);
		...
		update() {
			...
			let e = V.now();
			B.delta = N(0, 1e3 / 60, e - B.timestamp), B.timestamp = e, B.isProcessing = !0, yt.update.process(B), yt.preRender.process(B), yt.render.process(B), B.isProcessing = !1;
		}
		didUpdate() {
		...
		measurePageBox() {
			...
			if (!(this.scroll?.wasRoot || this.path.some(Qc))) {
				...
				e && (Z(t.x, e.offset.x), Z(t.y, e.offset.y));
			}
			return t;
		}
		removeElementScroll(e) {
			...
			for (let n = 0; n < this.path.length; n++) {
				...
				r !== this.root && i && a.layoutScroll && (i.wasRoot && Q(t, e), Z(t.x, i.offset.x), Z(t.y, i.offset.y));
			}
			return t;
		}
		applyTransform(e, t = !1, n) {
			...
			for (let e = 0; e < this.path.length; e++) {
				let n = this.path[e];
				!t && n.options.layoutScroll && n.scroll && n !== n.root && (Z(r.x, -n.scroll.offset.x), Z(r.y, -n.scroll.offset.y)), Mo(n.latestValues) && Wo(r, n.latestValues, n.layout?.layoutBox);
			}
			return Mo(this.latestValues) && Wo(r, this.latestValues, this.layout?.layoutBox), r;
		}
		removeTransform(e) {
			let t = X();
			Q(t, e);
			for (let e = 0; e < this.path.length; e++) {
				...
				let r;
				n.instance && (jo(n.latestValues) && n.updateSnapshot(), r = X(), Q(r, n.measurePageBox())), Ks(t, n.latestValues, n.snapshot?.layoutBox, r);
			}
			return Mo(this.latestValues) && Ks(t, this.latestValues), t;
		}
		setTargetDelta(e) {
		...
		resolveTargetDelta(e = !1) {
			...
			a && this.linkedParentVersion !== a.layoutVersion && !a.options.layoutRoot && this.removeRelativeTarget(), !this.targetDelta && !this.relativeTarget && (this.options.layoutAnchor !== !1 && a && a.layout ? this.createRelativeTarget(a, this.layout.layoutBox, a.layout.layoutBox) : this.removeRelativeTarget()), !(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = X(), this.targetWithTransforms = X()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), Rs(this.target, this.relativeTarget, this.relativeParent.target, this.options.layoutAnchor || void 0)) : this.targetDelta ? (this.resumingFrom ? this.applyTransform(this.layout.layoutBox, !1, this.target) : Q(this.target, this.layout.layoutBox), Ro(this.target, this.targetDelta)) : Q(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget && (this.attemptToResolveRelativeTarget = !1, this.options.layoutAnchor !== !1 && a && !!a.resumingFrom == !!this.resumingFrom && !a.options.layoutScroll && a.target && this.animationProgress !== 1 ? this.createRelativeTarget(a, this.target, a.target) : this.relativeParent = this.relativeTarget = void 0), R.value && bc.calculatedTargetDeltas++);
		}
		...
		createRelativeTarget(e, t, n) {
			this.relativeParent = e, this.linkedParentVersion = e.layoutVersion, this.forceRelativeParentToResolveTarget(), this.relativeTarget = X(), this.relativeTargetOrigin = X(), Bs(this.relativeTargetOrigin, t, n, this.options.layoutAnchor || void 0), Q(this.relativeTarget, this.relativeTargetOrigin);
		}
		...
		setAnimationOrigin(e, t = !1) {
			...
			this.mixTargetDelta = (t) => {
				let n = t / 1e3;
				Hc(a.x, e.x, n), Hc(a.y, e.y, n), this.setTargetDelta(a), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (Bs(o, this.layout.layoutBox, this.relativeParent.layout.layoutBox, this.options.layoutAnchor || void 0), Wc(this.relativeTarget, this.relativeTargetOrigin, o, n), d && Xs(this.relativeTarget, d) && (this.isProjectionDirty = !1), d ||= X(), Q(d, this.relativeTarget)), s && (this.animationValues = i, sc(i, r, this.latestValues, n, u, l)), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = n;
			}, this.mixTargetDelta(this.options.layoutRoot ? 1e3 : 0);
		}
		startAnimation(e) {
			this.notifyListeners("animationStart"), this.currentAnimation?.stop(), this.resumingFrom?.currentAnimation?.stop(), this.pendingAnimation &&= (vt(this.pendingAnimation), void 0), this.pendingAnimation = z.update(() => {
				yc.hasAnimatedSinceResize = !0, St.layout++, this.motionValue ||= Ii(0), this.motionValue.jump(0, !1), this.currentAnimation = fc(this.motionValue, [0, 1e3], {
					...e,
					velocity: 0,
					isSync: !0,
					onUpdate: (t) => {
...
function kc(e) {
	R.value && bc.nodes++, e.parent && (e.isProjecting() || (e.isProjectionDirty = e.parent.isProjectionDirty), e.isSharedProjectionDirty ||= !!(e.isProjectionDirty || e.parent.isProjectionDirty || e.parent.isSharedProjectionDirty), e.isTransformDirty ||= e.parent.isTransformDirty);
}
function Ac(e) {
...
}, qc = (e) => typeof navigator < "u" && navigator.userAgent && navigator.userAgent.toLowerCase().includes(e), Jc = qc("applewebkit/") && !qc("chrome/") ? Math.round : F;
function Yc(e) {
...
function sl({ children: e, isPresent: t, anchorX: n, anchorY: r, root: i, pop: a }) {
	let o = ve(), s = k(null), c = k({
		...
		right: 0,
		bottom: 0
	}), { nonce: l } = O(nl), u = al(s, e.props?.ref ?? e?.ref);
	return ye(() => {
...
var pl = ({ children: e, custom: t, initial: n = !0, onExitComplete: r, presenceAffectsLayout: i = !0, mode: a = "sync", propagate: o = !1, anchorX: s = "left", anchorY: c = "top", root: l }) => {
	let [u, d] = ul(o), f = xe(() => fl(e), [e]), p = o && !u ? [] : f.map(dl), m = k(!0), h = k(f), g = Te(() => /* @__PURE__ */ new Map()), _ = k(/* @__PURE__ */ new Set()), [v, y] = A(f), [b, x] = A(f);
	Ee(() => {
	...
	let { forceRender: C } = O(we);
	return j(Se, { children: b.map((e) => {
...
function Al(e) {
	let { initial: t, animate: n } = kl(e, O(Ol));
	return xe(() => ({
		initial: t,
		animate: n
	}), [jl(t), jl(n)]);
...
function Nl(e, t, n) {
	for (let r in t) !J(t[r]) && !ns(r, n) && (e[r] = t[r]);
}
...
function Vl(e, t, n, { latestValues: r }, i, a = !1, o) {
	let s = (o ?? Bl(e) ? Rl : Il)(t, r, i, e), c = Dl(t, typeof e == "string", a), l = e === de ? {} : {
		...
		...s,
		ref: n
	}, { children: u } = t, d = xe(() => J(u) ? u.get() : u, [u]);
	return me(e, {
		...l,
		children: d
	});
...
var Wl = (e) => (t, n) => {
	let r = O(Ol), i = O(De), a = () => Hl(e, t, r, i);
	return n ? a() : Te(a);
}, Gl = /*@__PURE__*/ Wl({
...
function Zl(e, t, n, r, i, a) {
	let { visualElement: o } = O(Ol), s = O(ml), c = O(De), l = O(nl), u = l.reducedMotion, d = l.skipAnimations, f = k(null), p = k(!1);
	...
	let m = f.current, h = O(Yl);
	m && !m.projection && i && (m.type === "html" || m.type === "svg") && Ql(f.current, n, i, h);
	let g = k(!1);
	ye(() => {
		m && g.current && m.update(n, c);
	});
	let _ = n[Wi], v = k(!!_ && typeof window < "u" && !window.MotionHandoffIsComplete?.(_) && window.MotionHasOptimisedAnimation?.(_));
	return Ee(() => {
...
function nu(e, t) {
	...
	if (process.env.NODE_ENV !== "production" && t && n) {
		...
		e.ignoreStrict ? je(!1, t, "lazy-strict-mode") : P(!1, t, "lazy-strict-mode");
	}
}
function ru(e) {
...
function iu(e, t) {
	...
	return new Proxy((e, t) => (process.env.NODE_ENV !== "production" && Ue(!1, "motion() is deprecated. Use motion.create() instead."), r(e, t)), { get: (i, a) => a === "create" ? r : (n.has(a) || n.set(a, eu(a, void 0, e, t)), n.get(a)) });
}
//#endregion
...
var au = (e, t) => t.isSVG ?? Bl(e) ? new _s(t) : new as(t, { allowProjection: e !== de }), ou = class extends Eo {
	constructor(e) {
...
var hu = /*#__PURE__*/ new Set(["auto", "scroll"]), gu = class {
	constructor(e, t, { transformPagePoint: n, contextWindow: r = window, dragSnapToOrigin: i = !1, distanceThreshold: a = 3, element: o } = {}) {
		if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.lastRawMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.scrollPositions = /* @__PURE__ */ new Map(), this.removeScrollListeners = null, this.onElementScroll = (e) => {
			...
			this.lastMoveEvent = e, this.lastRawMoveEventInfo = t, this.lastMoveEventInfo = _u(t, this.transformPagePoint), z.update(this.updatePoint, !0);
		...
		let s = _u(lu(e), this.transformPagePoint), { point: c } = s, { timestamp: l } = B;
		this.history = [{
			...c,
			timestamp: l
		}];
		let { onSessionStart: u } = t;
		u && u(e, yu(s, this.history)), this.removeListeners = Re(du(this.contextWindow, "pointermove", this.handlePointerMove), du(this.contextWindow, "pointerup", this.handlePointerUp), du(this.contextWindow, "pointercancel", this.handlePointerUp)), o && this.startScrollTracking(o);
	}
...
function Ou(e, t) {
	let n = .5, r = $(e), i = $(t);
	return i > r ? n = /* @__PURE__ */ ze(t.min, t.max - r, e.min) : r > i && (n = /* @__PURE__ */ ze(e.min, e.max - i, t.min)), N(0, 1, n);
}
function ku(e, t) {
	let n = {};
...
var Pu = /* @__PURE__ */ new WeakMap(), Fu = class {
	...
	start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
		...
		let i = (e) => {
			...
			}), i && z.update(() => i(e, t), !1, !0), Hi(this.visualElement, "transform");
...
var Bu = class extends Eo {
	constructor(e) {
		super(e), this.removeGroupControls = F, this.removeListeners = F, this.controls = new Fu(e);
	}
	mount() {
	...
	getSnapshotBeforeUpdate(e) {
		...
		return a ? (a.isPresent = i, e.layoutDependency !== t && a.setOptions({
			...a.options,
			layoutDependency: t
		}), Uu = !0, r || e.layoutDependency !== t || t === void 0 || e.isPresent !== i ? a.willUpdate() : this.safeToRemove(), e.isPresent !== i && (i ? a.promote() : a.relegate() || z.postRender(() => {
			let e = a.getStack();
...
var Ju = class extends Eo {
	...
	mount() {
		this.unmount = Re(pc(this.node.current, "focus", () => this.onFocus()), pc(this.node.current, "blur", () => this.onBlur()));
	}
	unmount() {}
};
//#endregion
...
function Ed(e, { defaultTransition: t = {}, ...n } = {}, r, i) {
	...
	for (let n = 0; n < e.length; n++) {
		...
		let g = 0, _ = (e, n, r, o = 0, s = 0) => {
			...
			if (ee > 0 && Jn(u, ee), c.length === 1 && c.unshift(null), m) {
				P(m < Td, "Repeat count too high, must be less than 20", "repeat-count-high"), b = vd(b, m);
				let e = [...c], t = [...u];
...
function nf({ forceDark: e = !1 } = {}) {
	let [t, n] = A(""), [r, i] = A(""), a = S((e) => e.wallpaperTextTheme), o = e || a === "dark" ? "text-white/85" : "text-black/80";
	return _e(() => {
		let e = () => {
...
var df = "PopoverAnchor", ff = T.forwardRef((e, t) => {
	...
	return T.useEffect(() => (o(), () => s()), [o, s]), /* @__PURE__ */ j(h, {
		...a,
		...r,
		ref: t
	});
...
var pf = "PopoverTrigger", mf = T.forwardRef((t, n) => {
	let { __scopePopover: i, ...a } = t, o = lf(pf, i), s = sf(i), c = r(n, o.triggerRef), l = /* @__PURE__ */ j(u.button, {
		type: "button",
	...
	return o.hasCustomAnchor ? l : /* @__PURE__ */ j(h, {
		asChild: !0,
		...s,
		children: l
	});
...
var yf = "PopoverContent", bf = T.forwardRef((e, t) => {
	...
	return /* @__PURE__ */ j(d, {
		present: r || a.open,
		children: a.modal ? /* @__PURE__ */ j(Sf, {
			...i,
			ref: t
		}) : /* @__PURE__ */ j(Cf, {
			...i,
...
function Uf({ children: e, className: t, variant: n = "panel", forceGlass: r, borderRadius: i, style: a, ref: o, ...s }) {
	...
	return u ? d === "clear" ? /* @__PURE__ */ M("div", {
		...
		children: [
			...
			u && /* @__PURE__ */ j(zf, { className: "absolute inset-0 w-full h-full z-30 opacity-25 pointer-events-none" }),
			u && g && /* @__PURE__ */ j("svg", {
				"aria-hidden": !0,
				style: {
					position: "absolute",
	...
	return /* @__PURE__ */ M(Af, {
		...
		children: [/* @__PURE__ */ j(jf, {
			...
			children: /* @__PURE__ */ j("button", {
				...
				children: /* @__PURE__ */ j(Qd, { className: "w-3.5 h-3.5" })
			})
		}), /* @__PURE__ */ j(Mf, { children: /* @__PURE__ */ j(Nf, {
			align: "end",
			sideOffset: 6,
					...
					children: [
						/* @__PURE__ */ M("div", {
							...
							children: [/* @__PURE__ */ j("div", {
								...
								children: /* @__PURE__ */ j(tf, { className: "w-4 h-4 text-white" })
						...
						/* @__PURE__ */ M("div", {
							...
							children: [/* @__PURE__ */ j("p", {
								...
								children: [
									...
									{
										id: "dark",
										icon: /* @__PURE__ */ j(Xd, { className: "w-3 h-3" })
									}
						...
						/* @__PURE__ */ M("div", {
							...
							children: [/* @__PURE__ */ M("div", {
								...
								children: [
									/* @__PURE__ */ j(ie, { className: C("w-3 h-3", m) }),
									/* @__PURE__ */ j("p", {
										className: C("text-xs font-semibold", m),
										children: "Brightness"
									}),
						...
						/* @__PURE__ */ M("div", {
							...
							children: [/* @__PURE__ */ M("div", {
								className: "flex items-center gap-2 mb-2",
								children: [
									/* @__PURE__ */ j(ae, { className: C("w-3 h-3", m) }),
									/* @__PURE__ */ j("p", {
										className: C("text-xs font-semibold", m),
										children: "Sound"
									}),
						...
						/* @__PURE__ */ M("div", {
							...
							children: [/* @__PURE__ */ j("p", {
								...
								children: /* @__PURE__ */ j("span", { className: C("absolute top-0.5 w-4 h-4 bg-white rounded-full shadow transition-all", a ? "left-5" : "left-0.5") })
							})]
						})
					]
				})
...
var Gf = pe("dark");
function Kf() {
	return O(Gf) === "light" ? "text-black/80 hover:bg-black/10" : "text-white/85 hover:bg-white/10";
}
...
function Qf({ item: e, t, onSelect: n }) {
	let [r, i] = A(!1), [a, o] = A(null), s = k(null), c = k(null), l = !!e.children && e.children.length > 0, u = D(() => {
	...
	return _e(() => () => {
		...
		children: [/* @__PURE__ */ M("button", {
			...
			children: [/* @__PURE__ */ j("span", { children: Zf(e.label, t) }), /* @__PURE__ */ j(ee, { className: "w-3.5 h-3.5 ml-6 opacity-60" })]
		}), r && a && typeof document < "u" && Ce(/* @__PURE__ */ j("div", {
			...
			children: /* @__PURE__ */ j(Uf, {
				...
				children: e.children.map((e, r) => e.separator ? /* @__PURE__ */ j(Yf, {}, `sep-${r}`) : /* @__PURE__ */ j(Qf, {
					item: e,
					t,
					onSelect: n
				}, e.key))
...
function $f({ anchorRef: e, open: t, onClose: n, minWidth: r = 192, children: i }) {
	...
	return _e(() => {
		...
		n,
		e
	]), !t || !a || typeof document > "u" ? null : Ce(/* @__PURE__ */ j("div", {
		ref: s,
		"data-menu-portal": "true",
		className: "fixed z-[99999] outline-none",
		style: {
...
function ep({ onClose: e }) {
	let [t, n] = A({
		x: 0,
		y: 0
	}), [r, i] = A(!1), a = k(null), o = D((e) => {
	...
	return typeof document > "u" ? null : Ce(/* @__PURE__ */ M("div", {
...
function tp({ activeId: e, setActiveId: t }) {
	let n = e === "apple", r = D((e) => {
		t((typeof e == "function" ? e(n) : e) ? "apple" : null);
	}, [n, t]), i = Kf(), [a, o] = A(!1), s = k(null), c = S((e) => e.apps), l = S((e) => e.launchApp), { t: u } = se(), d = D(() => r(!1), [r]);
	return /* @__PURE__ */ M(Se, { children: [
		...
		a && /* @__PURE__ */ j(ep, { onClose: () => o(!1) })
	] });
}
//#endregion
//#region src/components/menubar/AppNameDropdown.tsx
function np({ appConfig: e, appId: t, activeId: n, setActiveId: r }) {
	let i = n === "app-name", a = D((e) => {
		r((typeof e == "function" ? e(i) : e) ? "app-name" : null);
	}, [i, r]), o = Kf(), s = k(null), c = S((e) => e.closeWindow), { t: l, getAppName: u } = se();
	if (!e) return null;
	let d = u(e.id, e.name), f = D(() => a(!1), [a]), p = (e) => {
	...
	return /* @__PURE__ */ M(Se, { children: [/* @__PURE__ */ j("button", {
		ref: s,
		onMouseDown: (e) => {
			e.button === 0 && a((e) => !e);
		},
		...
		children: [
			...
			/* @__PURE__ */ j(Yf, {}),
			h && h.length > 0 ? h.map((e, t) => e.separator ? /* @__PURE__ */ j(Yf, {}, `sep-${t}`) : /* @__PURE__ */ j(Qf, {
				item: e,
				t: l,
				onSelect: g
			}, e.key)) : /* @__PURE__ */ M(Se, { children: [
				/* @__PURE__ */ j(Jf, {
					label: l.services,
					disabled: !0
				}),
...
function rp({ label: e, items: t, appId: n, windowId: r, activeId: i, setActiveId: a }) {
	let o = i === e, s = D((t) => {
		...
		e,
		a
	]), c = Kf(), l = k(null), { t: u } = se(), d = D(() => s(!1), [s]), f = (e) => {
	...
	return /* @__PURE__ */ M(Se, { children: [/* @__PURE__ */ j("button", {
		...
		onClose: d,
		minWidth: 192,
		children: t.map((e, t) => e.separator ? /* @__PURE__ */ j(Yf, {}, `sep-${t}`) : /* @__PURE__ */ j(Qf, {
			item: e,
			t: u,
			onSelect: f
		}, e.key))
...
function ap({ features: e, children: t }) {
	return /* @__PURE__ */ j(ip.Provider, {
		value: e,
		children: t
	});
}
...
function sp({ onSpotlight: e, isSimpleMode: t = !1, forceDark: n = !1, fallbackMenuBarAppId: r = null } = {}) {
	let i = op(), a = S((e) => e.activeAppId), o = S((e) => e.apps), s = a ?? r, c = s ? o[s] : null, l = i.menuBar.appleMenu, u = i.menuBar.appNameMenu && !!c, d = c?.menuBarMenus ?? [], f = S((e) => e.wallpaperTextTheme), p = n ? "dark" : f, m = C(qf, "px-2", p === "light" ? "text-black/70 hover:bg-black/10" : "text-white/80 hover:bg-white/10"), [h, g] = A(null);
	if (!i.menuBar.enabled) return null;
	let _ = i.menuBar.spotlight || i.menuBar.controlCenter || i.menuBar.clock;
	return /* @__PURE__ */ j(Gf.Provider, {
		value: p,
		children: /* @__PURE__ */ j(Uf, {
			variant: "menubar",
			forceGlass: !n && void 0,
				...
				children: [
					...
					_ && /* @__PURE__ */ M("div", {
						...
						children: [
							...
							i.menuBar.controlCenter && /* @__PURE__ */ M(Se, { children: [
								/* @__PURE__ */ j("button", {
									className: m,
									children: /* @__PURE__ */ j(tf, { className: "w-3.5 h-3.5" })
								}),
								/* @__PURE__ */ j("button", {
									className: m,
									children: /* @__PURE__ */ j(Kd, { className: "w-3.5 h-3.5" })
								}),
								/* @__PURE__ */ j(Wf, { forceDark: n })
							] }),
							i.menuBar.clock && /* @__PURE__ */ j("div", {
								className: "flex h-6 items-center rounded-md px-2",
								children: /* @__PURE__ */ j(nf, { forceDark: n })
							})
						]
					})
				]
...
function cp({ appName: e, error: t, onRetry: n }) {
	let { t: r } = se();
	return /* @__PURE__ */ M("div", {
		className: "flex h-full w-full flex-col items-center justify-center gap-3 px-6 text-center",
		children: [
			/* @__PURE__ */ j($d, { className: "h-6 w-6 text-black/30 dark:text-white/30" }),
			/* @__PURE__ */ M("div", {
...
var lp = class extends ue {
	...
	render() {
		return this.state.error ? /* @__PURE__ */ j(cp, {
	...
	Finder: E(() => import("./Finder-CyOvQbZF.js").then((e) => ({ default: e.Finder }))),
	Terminal: E(() => import("./Terminal-bV4MUGHt.js").then((e) => ({ default: e.Terminal }))),
	Settings: E(() => import("./Settings-2aaumjhW.js").then((e) => ({ default: e.Settings }))),
	Browser: E(() => import("./Browser-BIl5C3t1.js").then((e) => ({ default: e.Browser }))),
	TextEditor: E(() => import("./TextEditor-DBYIlqT3.js").then((e) => ({ default: e.TextEditor }))),
	Clock: E(() => import("./Clock-DBrWK5G4.js").then((e) => ({ default: e.Clock }))),
	Calculator: E(() => import("./Calculator-BH4UOaPi.js").then((e) => ({ default: e.Calculator }))),
	Notes: E(() => import("./Notes-DfFoXpMe.js").then((e) => ({ default: e.Notes }))),
	Photos: E(() => import("./Photos-B05aU8R_.js").then((e) => ({ default: e.Photos }))),
	Music: E(() => import("./Music-B65Ru7XW.js").then((e) => ({ default: e.Music }))),
	Calendar: E(() => import("./Calendar-Cc_-2eqC.js").then((e) => ({ default: e.Calendar }))),
	Messages: E(() => import("./Messages-BJK82ksB.js").then((e) => ({ default: e.Messages }))),
	IframeApp: E(() => import("./IframeApp-DZ3b9VXX.js").then((e) => ({ default: e.IframeApp }))),
	MdxApp: E(() => import("./MdxApp-Jf3-FVYV.js").then((e) => ({ default: e.MdxApp })))
};
function dp() {
	return /* @__PURE__ */ j("div", {
		className: "flex items-center justify-center h-full w-full",
		children: /* @__PURE__ */ j(Jd, { className: "w-6 h-6 animate-spin text-black/30 dark:text-white/30" })
	});
}
function fp({ appId: e, windowId: t }) {
	let n = S((t) => t.apps[e]);
	...
	if (n.render) {
		...
		return /* @__PURE__ */ j(fe, {
			fallback: /* @__PURE__ */ j(dp, {}),
			children: /* @__PURE__ */ j(ce, { children: /* @__PURE__ */ j(lp, {
				appId: e,
				appName: n.name,
	...
	let r = n.component ? up[n.component] : void 0;
...
function pp({ menus: e, appId: t, open: n, onClose: r }) {
	let { t: i } = se(), [a, o] = A(null), s = D((e) => {
		e.action && window.dispatchEvent(new CustomEvent("app:menu:action", { detail: {
			appId: t,
			action: e.action
		} })), r();
	}, [t, r]);
	return typeof document > "u" ? null : Ce(/* @__PURE__ */ j(pl, { children: n && /* @__PURE__ */ M(Se, { children: [/* @__PURE__ */ j(ld.div, {
		initial: { opacity: 0 },
		animate: { opacity: 1 },
		exit: { opacity: 0 },
		className: "fixed inset-0 bg-black/30 z-[2000]",
		onClick: r
	}, "backdrop"), /* @__PURE__ */ M(ld.div, {
		initial: { y: "100%" },
		animate: { y: 0 },
		exit: { y: "100%" },
		transition: {
		...
		children: [/* @__PURE__ */ j("div", {
			...
			children: e.map((e) => /* @__PURE__ */ M("div", {
				...
				children: [/* @__PURE__ */ j("div", {
					...
					children: e.items.map((e, t) => e.separator ? /* @__PURE__ */ j("div", { className: "h-px mx-3 bg-black/8 dark:bg-white/10" }, `sep-${t}`) : /* @__PURE__ */ j(mp, {
						item: e,
						t: i,
						onSelect: s,
						expandedKey: a,
...
function mp({ item: e, t, onSelect: n, expandedKey: r, setExpandedKey: i, depth: a = 0 }) {
	...
	return o ? /* @__PURE__ */ M("div", { children: [/* @__PURE__ */ M("button", {
		...
		children: [/* @__PURE__ */ j("span", { children: Zf(e.label, t) }), /* @__PURE__ */ j(qd, { className: C("w-4 h-4 opacity-50 transition-transform", s && "rotate-180") })]
	}), /* @__PURE__ */ j(pl, {
		initial: !1,
		children: s && /* @__PURE__ */ j(ld.div, {
			initial: {
				height: 0,
				opacity: 0
			},
			...
			children: e.children.map((e, o) => e.separator ? /* @__PURE__ */ j("div", { className: "h-px mx-3 bg-black/8 dark:bg-white/10" }, `sep-${o}`) : /* @__PURE__ */ j(mp, {
				item: e,
				t,
				onSelect: n,
				expandedKey: r,
		...
		children: [/* @__PURE__ */ j("span", { children: Zf(e.label, t) }), e.shortcut && /* @__PURE__ */ j("span", {
...
function _p({ statusBarHeight: e, navBarHeight: t, homeIndicatorHeight: n = 20 }) {
	let r = S((e) => e.windows), i = S((e) => e.apps), a = S((e) => e.closeWindow), [o, s] = A(!1), [c, l] = A(!1), u = Object.values(r).filter((e) => !e.isMinimized).sort((e, t) => t.zIndex - e.zIndex), d = u[0] ?? null, f = D(() => {
		d && a(d.id);
	}, [d, a]), p = d ? i[d.appId] : null, m = Ud(), h = ud(0), g = pd(h, [0, -220], [1, .75]), _ = pd(h, [0, -220], [0, 48]);
	return /* @__PURE__ */ j(pl, { children: d && p && /* @__PURE__ */ M(ld.div, {
		initial: {
			scale: .88,
			opacity: 0
		},
		...
		children: [
				...
				children: !o && /* @__PURE__ */ M(ld.div, {
					...
					children: [
						...
						p.menuBarMenus && p.menuBarMenus.length > 0 ? /* @__PURE__ */ j("button", {
							...
							children: /* @__PURE__ */ j(Yd, { className: "w-5 h-5" })
			...
			/* @__PURE__ */ j("div", {
				...
				children: /* @__PURE__ */ j(hp.Provider, {
					value: s,
			...
			p.menuBarMenus && p.menuBarMenus.length > 0 && /* @__PURE__ */ j(pp, {
...
//#endregion
export { pl as C, z as D, ar as E, ld as S, J as T, Gd as _, ap as a, pd as b, Uf as c, ef as d, Qd as f, Kd as g, qd as h, sp as i, nf as l, Xd as m, gp as n, op as o, Zd as p, fp as r, rp as s, _p as t, tf as u, Wd as v, nl as w, ud as x, Bd as y };
