...
export declare const menuBarButtonClass = "flex h-6 items-center rounded-md px-2.5 text-[14px] leading-none transition-colors";
export declare function MenuItem({ label, shortcut, disabled, checked, onClick, }: {
    label: string;
    shortcut?: string;
    disabled?: boolean;
    checked?: boolean;
